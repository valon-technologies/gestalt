...
| `GET` | `/api/v1/auth/pending-connection` | Render the multi-candidate connection selection page. |
| `POST` | `/api/v1/auth/pending-connection` | Finalize a multi-candidate connection choice. |
