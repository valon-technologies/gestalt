...
The Toolshed binary registers all plugins at startup. Bootstrap builds one shared invoker and passes scoped deps to runtimes and bindings.
...
| `mongodb` | MongoDB with configurable database name (default: `toolshed`). |
