...
This file shows several features together in one place. The smaller blocks
below are field excerpts, not standalone configs.
...
integrations:
  ...
  slack:
    display_name: Slack
    plugin:
      package: ./dist/slack-plugin.tar.gz
