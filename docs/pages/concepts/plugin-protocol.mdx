...
| `config_schema_json` | `string` | Optional JSON Schema describing the `plugin.config` block. Currently used for documentation only; runtime validation requires executing the binary until static manifests land in a future release. |
