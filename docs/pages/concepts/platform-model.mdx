...
Toolshed has a small set of primitives. Once you understand how they fit together, the rest of the system is predictable.

## Core primitives

| Primitive | What it does |
|---|---|
| Auth provider | Authenticates users to the Toolshed platform and issues session tokens. |
...
6. Toolshed executes the upstream HTTP call, runs response-check hooks if configured, and returns the result.
