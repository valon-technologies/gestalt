...
| `config.yaml` | The declarative control plane. This is where you define auth, datastore, secrets, providers, and UI overrides. |
...
Your YAML file declares the feature sets that make up a Gestalt deployment: platform auth, token storage, secret resolution, providers, and optional UI overrides.
