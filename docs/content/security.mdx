...
Gestalt sits between callers and upstream APIs. It authenticates users, stores encrypted credentials, and isolates plugin processes. For implementation details, see [Architecture](/architecture).
