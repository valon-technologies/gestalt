...
<Tabs items={['Go', 'Python', 'Rust', 'TypeScript']}>
  ...
  <Tabs.Tab>
    ...
    The authentication provider manifest points Gestalt at the executable
...
- [Configuration](/reference/configuration): full config examples including `providers.authentication`
