...
<Tabs items={['Go', 'Python', 'Rust', 'TypeScript']}>
  <Tabs.Tab>
    ...
    func summarize(ctx context.Context) (string, error) {
        ...
        session, err := agents.CreateSessionRaw(ctx, &client.CreateAgentProviderSessionRequest{
            ClientRef: "roadmap-risk",
        })
        if err != nil {
            return "", err
        ...
        turn, err := agents.CreateTurnRaw(ctx, &client.CreateAgentProviderTurnRequest{
  ...
  <Tabs.Tab>
    ...
    def summarize(request: Request) -> str:
        ...
        session = agents.create_session(client_ref="roadmap-risk")
  ...
  <Tabs.Tab>
    ...
    use gestalt::Agent;
    use gestalt::agent::{
        AgentMessage, CreateAgentProviderSessionRequest,
    ...
    async fn summarize() -> Result<String, Box<dyn std::error::Error>> {
        ...
        let session = agents
            .create_session_raw(CreateAgentProviderSessionRequest {
        ...
        let turn = agents
            .create_turn_raw(CreateAgentProviderTurnRequest {
                session_id: session.id,
  ...
  <Tabs.Tab>
    ...
    export async function summarize() {
      ...
      const session = await agents.createSessionRaw({
        idempotencyKey: "",
        model: "",
        clientRef: "roadmap-risk",
        metadata: {},
      ...
      const turn = await agents.createTurnRaw({
        turnId: "",
        sessionId: session.id,
        idempotencyKey: "",
        model: "",
