...
| --- | --- |
| `IndexedDB.CreateObjectStore` | [`IDBDatabase.createObjectStore`](https://www.w3.org/TR/IndexedDB/#dom-idbdatabase-createobjectstore) |
| `IndexedDB.DeleteObjectStore` | [`IDBDatabase.deleteObjectStore`](https://www.w3.org/TR/IndexedDB/#dom-idbdatabase-deleteobjectstore) |
| `IndexedDB.Get` | [`IDBObjectStore.get`](https://www.w3.org/TR/IndexedDB/#dom-idbobjectstore-get) |
| `IndexedDB.GetKey` | [`IDBObjectStore.getKey`](https://www.w3.org/TR/IndexedDB/#dom-idbobjectstore-getkey) |
| `IndexedDB.Add` | [`IDBObjectStore.add`](https://www.w3.org/TR/IndexedDB/#dom-idbobjectstore-add) |
| `IndexedDB.Put` | [`IDBObjectStore.put`](https://www.w3.org/TR/IndexedDB/#dom-idbobjectstore-put) |
| `IndexedDB.Delete` | [`IDBObjectStore.delete`](https://www.w3.org/TR/IndexedDB/#dom-idbobjectstore-delete) |
| `IndexedDB.GetAll` | [`IDBObjectStore.getAll`](https://www.w3.org/TR/IndexedDB/#dom-idbobjectstore-getall) |
| `IndexedDB.GetAllKeys` | [`IDBObjectStore.getAllKeys`](https://www.w3.org/TR/IndexedDB/#dom-idbobjectstore-getallkeys) |
| `IndexedDB.Count` | [`IDBObjectStore.count`](https://www.w3.org/TR/IndexedDB/#dom-idbobjectstore-count) |
| `IndexedDB.Clear` | [`IDBObjectStore.clear`](https://www.w3.org/TR/IndexedDB/#dom-idbobjectstore-clear) |
| `IndexedDB.DeleteRange` | [`IDBObjectStore.delete`](https://www.w3.org/TR/IndexedDB/#dom-idbobjectstore-delete) (with key range) |
| `IndexedDB.IndexGet` | [`IDBIndex.get`](https://www.w3.org/TR/IndexedDB/#dom-idbindex-get) |
| `IndexedDB.IndexGetKey` | [`IDBIndex.getKey`](https://www.w3.org/TR/IndexedDB/#dom-idbindex-getkey) |
| `IndexedDB.IndexGetAll` | [`IDBIndex.getAll`](https://www.w3.org/TR/IndexedDB/#dom-idbindex-getall) |
| `IndexedDB.IndexGetAllKeys` | [`IDBIndex.getAllKeys`](https://www.w3.org/TR/IndexedDB/#dom-idbindex-getallkeys) |
| `IndexedDB.IndexCount` | [`IDBIndex.count`](https://www.w3.org/TR/IndexedDB/#dom-idbindex-count) |
| `IndexedDB.IndexDelete` | [`IDBIndex.delete`](https://www.w3.org/TR/IndexedDB/#dom-idbindex-delete) |
