...
| `auth` | Platform authentication backends | `providers.auth.<name>` |
...
| Authentication | [`auth/`](https://github.com/valon-technologies/gestalt-providers/tree/main/auth) | `providers.auth.<name>` |
