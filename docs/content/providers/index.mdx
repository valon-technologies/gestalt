...
The provider kind determines where the provider appears in configuration and how
Gestalt routes requests to it.
...
[`valon-technologies/gestalt-providers`](https://github.com/valon-technologies/gestalt-providers).
The repository is organized by provider type, and the published packages are
