...
[gestaltd.ai/registry](https://gestaltd.ai/registry). The registry lists
...
[gestaltd.ai/registry](https://gestaltd.ai/registry). The registry is the
...
```text
valon  github.com/valon-technologies/gestalt-providers/app/github  GitHub
```
...
```sh
gestaltd provider repo add valon https://raw.githubusercontent.com/valon-technologies/gestalt-providers/main/provider-index.yaml
```
