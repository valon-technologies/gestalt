...
[Building an Application > Calling another plugin from your application](/building-an-application#calling-another-plugin-from-your-application).
...
For application composition, see [Building an Application](/building-an-application).
