...
<Tabs items={['Go', 'Python', 'Rust', 'TypeScript']}>
  ...
  <Tabs.Tab>
    ...
    const avatar = { key: "avatars/user-123.png", versionId: "" };
    ...
    const { meta, data } = await s3.readObject({
      ref: avatar,
      ifMatch: "",
      ifNoneMatch: "",
    });
    ...
    class Provider(S3Provider):
        ...
        def presign_object(
            ...
            return PresignObjectResponse(
                ...
                or PresignMethodValues.PRESIGN_METHOD_GET,
    ...
    export const provider = defineS3Provider({
      ...
      async presignObject(ref, options) {
        return {
          ...
          method: options?.method ?? PresignMethod.PRESIGN_METHOD_GET,
