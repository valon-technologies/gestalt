...
connection bindings, read [Agent](/providers/agent#building-your-own-agent-provider).
To build a custom credential backend, read
[External Credentials](/providers/external-credentials#building-your-own-external-credentials-provider).
