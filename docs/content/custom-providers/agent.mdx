...
| Host method | Purpose |
| --- | --- |
| `SearchTools` | Ask Gestalt to resolve candidate tools for the current turn. |
...
that grant back to `SearchTools` or `ExecuteTool`; it is the scoped authority
...
<Tabs items={['Go', 'Python', 'Rust', 'TypeScript']}>
  ...
  <Tabs.Tab>
    ```python
    import gestalt
    from gestalt.gen.v1 import agent_pb2 as pb
    ...
    class ExampleAgent(gestalt.AgentProvider):
        def CreateSession(self, request, context):
            return pb.AgentSession(
                id=request.session_id,
                provider_name="example",
                model=request.model,
                client_ref=request.client_ref,
                state=pb.AGENT_SESSION_STATE_ACTIVE,
        ...
        def CreateTurn(self, request, context):
            return pb.AgentTurn(
                ...
                provider_name="example",
                model=request.model,
                status=pb.AGENT_EXECUTION_STATUS_RUNNING,
        ...
        def GetTurn(self, request, context):
            return pb.AgentTurn(
                ...
                provider_name="example",
                status=pb.AGENT_EXECUTION_STATUS_SUCCEEDED,
                output_text="done",
                created_by=actor_from_subject(request.subject),
            )
        ...
        def CancelTurn(self, request, context):
            return pb.AgentTurn(
                ...
                session_id="session-1",
                provider_name="example",
                status=pb.AGENT_EXECUTION_STATUS_CANCELED,
        ...
        def GetInteraction(self, request, context):
            return pb.AgentInteraction(
                id=request.interaction_id,
                state=pb.AGENT_INTERACTION_STATE_PENDING,
            )
        ...
        def ResolveInteraction(self, request, context):
            return pb.AgentInteraction(
                id=request.interaction_id,
                state=pb.AGENT_INTERACTION_STATE_RESOLVED,
