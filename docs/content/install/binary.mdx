...
<Tabs items={['macOS Apple Silicon', 'macOS Intel', 'Linux x86_64', 'Linux ARM64', 'Linux ARMv7', 'Windows x86_64']}>
  ...
  <Tabs.Tab>
    Download `gestalt-linux-x86_64.tar.gz` from the [latest release](https://github.com/valon-technologies/gestalt/releases?q=gestalt+CLI).
  ...
  <Tabs.Tab>
    Download `gestalt-linux-armv7.tar.gz` from the [latest release](https://github.com/valon-technologies/gestalt/releases?q=gestalt+CLI).
