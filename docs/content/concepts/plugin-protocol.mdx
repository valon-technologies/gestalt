...
The plugin receives this as a key-value map during startup. If the plugin needs config validation, declare it in the manifest with `provider.config_schema_path`.
