...
- [Identity](/providers/identity) flows, [credential storage](/providers/external-credentials), encryption at rest, token refresh, and [RBAC](/reference/config-file#authorization) on infrastructure you control.
...
<Cards>
  ...
  <Cards.Card title="Applications" href="/applications">
    Compose an app, UI, policy, IndexedDB, S3, and workflows.
  </Cards.Card>
