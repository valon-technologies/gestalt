...
<Tabs items={['Go', 'Python', 'Rust', 'TypeScript']}>
  <Tabs.Tab>
    ...
    func (p *Provider) generateNightly(
      ...
      if _, err := obj.WriteBytes(ctx, body, &gestalt.WriteRequest{
        ContentType: "application/json",
      }); err != nil {
        return gestalt.Response[NightlyReportOutput]{}, err
      }
      access, err := obj.CreateAccessURL(ctx, &gestalt.PresignRequest{
      ...
      _, err = workflows.DeliverEvent(ctx, gestalt.WorkflowDeliverEvent{
  ...
  <Tabs.Tab>
    ...
    async fn generate_nightly(
        ...
        let mut workflows = request.workflows().await?;
        workflows
      ...
      operations: [
        ...
        operation({
          ...
          async handler(input, request) {
            ...
            const workflows = new Workflow(request);
...
current request context to the host, and the host preserves the original
...
<Tabs items={['Go', 'Python', 'Rust', 'TypeScript']}>
  ...
  <Tabs.Tab>
    ```ts
    import { App, type Request } from "@valon-technologies/gestalt";
