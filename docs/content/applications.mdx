...
<Tabs items={['Go', 'Python', 'Rust', 'TypeScript']}>
  <Tabs.Tab>
    ...
    func (p *Provider) generateNightly(
      ...
      access, err := s3.PresignObject(
        ctx, client.PresignMethodGet, 900, "application/json", "", ref,
      )
      if err != nil {
        return gestalt.Response[NightlyReportOutput]{}, err
      }
  ...
  <Tabs.Tab>
    ...
    def generate_nightly(request: Request) -> dict[str, str]:
        ...
        access = s3.presign_object(
            method=PresignMethodValues.PRESIGN_METHOD_GET,
            expires_seconds=900,
            ref=ref,
        )
  ...
  <Tabs.Tab>
    ...
    use gestalt::s3::{S3ObjectRef, WriteObjectOpen, presign_method};
    use gestalt::workflow::WorkflowEvent;
      ...
      operations: [
        ...
        operation({
          ...
          async handler(_input, request) {
            ...
            const ref = {
              key: `nightly/${request.idempotencyKey}.json`,
              versionId: "",
            };
            ...
            const access = await s3.presignObject(
...
<Tabs items={['Go', 'Python', 'Rust', 'TypeScript']}>
  ...
  <Tabs.Tab>
    ```rust
    use gestalt::app::{RequestContext, SubjectContext};
    ...
    async fn load_linked_issue(
        ...
        let issue = app
            .invoke(
                "github".to_string(),                // app
                "issues.get".to_string(),            // operation
                "default".to_string(),               // connection
                String::new(),                       // instance
                request.idempotency_key.clone(),     // idempotency key
