...
| `gestalt app connect NAME` | Connect an app through OAuth or interactive manual authentication. |
| `gestalt app disconnect NAME` | Disconnect an app, removing stored credentials. |
...
Trigger creation uses the same app target input conventions as schedules.
