...
- [Configuration](/configuration) explains the config model, environment
  expansion, `gestaltd init`, `gestalt.lock.json`, and locked startup.
- [Plugins](/plugins) covers executable plugins, provider packages, and UI
  bundles.
