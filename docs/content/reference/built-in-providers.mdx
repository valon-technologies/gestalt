...
Apps and installable runtime providers are published separately from [`valon-technologies/gestalt-providers`](https://github.com/valon-technologies/gestalt-providers). Apps are configured under `plugins`; installable hosted runtimes are configured under `runtime.providers`:
