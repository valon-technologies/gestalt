...
| `plugins` | Tool providers exposed over HTTP, MCP, and CLI, plus optional plugin-backed UI mounts. |
...
`egress.allowedHosts`, and optional metadata fields. Plugin entries also
...
| Need | Read |
| --- | --- |
| Plugin setup, operation filtering, connections, and plugin-backed UIs | [Plugin](/providers/plugins) |
| Platform login | [Authentication](/providers/authentication) |
| RBAC, policies, service accounts, and dynamic grants | [Authorization](/providers/authorization) |
...
| Public UI bundles and plugin-backed UIs | [UI](/providers/ui) |
...
encryption key, and an HTTPBin test plugin.
