...
`gestalt::protocol` for protobuf well-known type conversions, `gestalt::proto::v1`
for generated protocol bindings in transport fixtures, and the JSON-named
IndexedDB conversion helpers when asserting lower-level datastore wire shapes.
