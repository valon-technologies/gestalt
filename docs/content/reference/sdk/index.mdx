...
Manager responses still mirror host response objects. Examples may therefore
read response fields with language-specific accessors. Native response objects
are a remaining SDK gap.
