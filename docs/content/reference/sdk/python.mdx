...
Generated protobuf stubs are private runtime internals. Provider code should
use the authored classes, clients, constants, and request builders exported from
`gestalt`.
