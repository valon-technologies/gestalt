...
| `static.public` | `false` | When `true`, serve static assets and theme endpoints without platform authentication or static-mount authorization. API routes for the app still require a session. |
