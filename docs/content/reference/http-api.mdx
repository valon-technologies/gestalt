...
step has an `id` and exactly one of `plugin` or `agent`. Plugin steps use
`plugin.name`, `plugin.operation`, and optional `connection`, `instance`, and
