...
| `workflow_target_component` | Target subcomponent involved in a workflow target authorization denial, such as `target`, `plugin_target`, `agent_provider`, or `agent_tool_ref`. |
