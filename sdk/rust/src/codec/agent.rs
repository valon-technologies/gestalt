...
use crate::codec::app::{
    from_wire_agent_tool_ref, from_wire_operation_annotations, from_wire_request_context,
...
pub(crate) fn from_wire_agent_catalog_tool_config(
...
pub(crate) fn to_wire_agent_interaction(value: AgentInteraction) -> v1::AgentInteraction {
    v1::AgentInteraction {
        id: value.id,
        r#type: value.r#type,
        state: value.state,
...
pub(crate) fn from_wire_agent_no_tools(_value: v1::AgentNoTools) -> AgentNoTools {
    AgentNoTools {}
}
...
pub(crate) fn to_wire_agent_provider_capabilities(
...
pub(crate) fn to_wire_agent_session(value: AgentSession) -> v1::AgentSession {
    v1::AgentSession {
        id: value.id,
...
pub(crate) fn from_wire_agent_session_start_config(
...
pub(crate) fn from_wire_agent_session_start_hook(
...
pub(crate) fn from_wire_agent_session_start_hook_output(
...
pub(crate) fn from_wire_agent_tool_config(value: v1::AgentToolConfig) -> AgentToolConfig {
    AgentToolConfig {
...
pub(crate) fn from_wire_agent_tool_config_source(
...
pub(crate) fn to_wire_agent_turn(value: AgentTurn) -> v1::AgentTurn {
    v1::AgentTurn {
        id: value.id,
        session_id: value.session_id,
        provider_name: value.provider_name,
...
pub(crate) fn to_wire_agent_turn_output(value: AgentTurnOutput) -> v1::agent_turn::Output {
    match value {
...
pub(crate) fn to_wire_agent_turn_display(value: AgentTurnDisplay) -> v1::AgentTurnDisplay {
    v1::AgentTurnDisplay {
        kind: value.kind,
        phase: value.phase,
        text: value.text,
...
pub(crate) fn to_wire_agent_turn_event(value: AgentTurnEvent) -> v1::AgentTurnEvent {
    v1::AgentTurnEvent {
        id: value.id,
        turn_id: value.turn_id,
        seq: value.seq,
...
pub(crate) fn to_wire_agent_turn_structured_output(
...
pub(crate) fn to_wire_agent_turn_text_output(
    value: AgentTurnTextOutput,
) -> v1::AgentTurnTextOutput {
...
pub(crate) fn from_wire_cancel_agent_provider_turn_request(
...
pub(crate) fn from_wire_create_agent_provider_session_request(
...
pub(crate) fn from_wire_create_agent_provider_turn_request(
...
pub(crate) fn from_wire_get_agent_provider_capabilities_request(
...
pub(crate) fn from_wire_get_agent_provider_interaction_request(
...
pub(crate) fn from_wire_get_agent_provider_session_request(
...
pub(crate) fn from_wire_get_agent_provider_turn_request(
...
pub(crate) fn from_wire_list_agent_provider_interactions_request(
...
pub(crate) fn to_wire_list_agent_provider_interactions_response(
...
pub(crate) fn from_wire_list_agent_provider_sessions_request(
...
pub(crate) fn to_wire_list_agent_provider_sessions_response(
...
pub(crate) fn from_wire_list_agent_provider_turn_events_request(
...
pub(crate) fn to_wire_list_agent_provider_turn_events_response(
...
pub(crate) fn from_wire_list_agent_provider_turns_request(
...
pub(crate) fn to_wire_list_agent_provider_turns_response(
...
pub(crate) fn from_wire_listed_agent_tool(value: v1::ListedAgentTool) -> ListedAgentTool {
    ListedAgentTool {
        id: value.id,
        mcp_name: value.mcp_name,
        title: value.title,
...
pub(crate) fn from_wire_resolve_agent_provider_interaction_request(
...
pub(crate) fn from_wire_update_agent_provider_session_request(
