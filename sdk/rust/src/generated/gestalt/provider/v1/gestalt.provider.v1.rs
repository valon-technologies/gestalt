...
pub struct ModelMessage {
    ...
    pub text: ::prost::alloc::string::String,
    #[prost(message, repeated, tag="3")]
    pub parts: ::prost::alloc::vec::Vec<ModelMessagePart>,
    #[prost(message, optional, tag="4")]
    pub metadata: ::core::option::Option<::prost_types::Struct>,
}
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct ModelMessagePart {
    #[prost(enumeration="ModelMessagePartType", tag="1")]
    pub r#type: i32,
    #[prost(string, tag="2")]
    pub text: ::prost::alloc::string::String,
}
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct ModelSubjectContext {
    #[prost(string, tag="1")]
    pub subject_id: ::prost::alloc::string::String,
    #[prost(string, tag="2")]
    pub subject_kind: ::prost::alloc::string::String,
...
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct GetModelProviderCapabilitiesRequest {
}
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct GenerateModelRequest {
    ...
    pub metadata: ::core::option::Option<::prost_types::Struct>,
    #[prost(message, optional, tag="7")]
    pub subject: ::core::option::Option<ModelSubjectContext>,
    #[prost(string, tag="8")]
...
pub struct GenerateModelResponse {
    #[prost(message, optional, tag="1")]
    pub message: ::core::option::Option<ModelMessage>,
    #[prost(string, tag="2")]
    pub output_text: ::prost::alloc::string::String,
    #[prost(message, optional, tag="3")]
    pub structured_output: ::core::option::Option<::prost_types::Struct>,
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ModelManagerGenerateRequest {
    #[prost(string, tag="1")]
    pub provider_name: ::prost::alloc::string::String,
    #[prost(string, tag="2")]
    pub model: ::prost::alloc::string::String,
...
impl ModelMessagePartType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "MODEL_MESSAGE_PART_TYPE_UNSPECIFIED",
            Self::Text => "MODEL_MESSAGE_PART_TYPE_TEXT",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "MODEL_MESSAGE_PART_TYPE_TEXT" => Some(Self::Text),
            _ => None,
        }
    }
}
...
impl ProviderKind {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::Model => "PROVIDER_KIND_MODEL",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "PROVIDER_KIND_MODEL" => Some(Self::Model),
            _ => None,
        }
    }
}
...
pub struct ManagedWorkflowDefinition {
    ...
    pub provider_name: ::prost::alloc::string::String,
    #[prost(message, optional, tag="2")]
    pub definition: ::core::option::Option<BoundWorkflowDefinition>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct WorkflowManagerCreateDefinitionRequest {
    #[prost(string, tag="2")]
    pub provider_name: ::prost::alloc::string::String,
    #[prost(message, optional, tag="3")]
    pub target: ::core::option::Option<BoundWorkflowTarget>,
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct WorkflowManagerUpdateDefinitionRequest {
    #[prost(string, tag="2")]
    pub definition_id: ::prost::alloc::string::String,
    #[prost(string, tag="3")]
    pub provider_name: ::prost::alloc::string::String,
