...
pub struct WorkflowStep {
    ...
    #[prost(message, optional, tag = "8")]
    pub metadata: ::core::option::Option<::prost_types::Struct>,
    #[prost(oneof = "workflow_step::Action", tags = "3, 4")]
...
pub struct WorkflowValue {
    #[prost(oneof = "workflow_value::Kind", tags = "1, 2, 3, 4, 5, 6, 7, 8, 9")]
...
pub mod workflow_value {
    ...
    pub enum Kind {
        ...
        #[prost(message, tag = "7")]
        SignalMetadata(super::WorkflowPathSource),
        #[prost(message, tag = "8")]
        WorkflowContext(super::WorkflowPathSource),
        #[prost(message, tag = "9")]
