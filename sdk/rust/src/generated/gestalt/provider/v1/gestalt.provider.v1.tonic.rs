        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/gestalt.provider.v1.Authorization/WriteRelationships" => {
                    #[allow(non_camel_case_types)]
                    struct WriteRelationshipsSvc<T: Authorization>(pub Arc<T>);
                    impl<T: Authorization>
                        ...
                        for WriteRelationshipsSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Authorization>::write_relationships(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
...
/// Generated client implementations.
pub mod remote_management_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::*;
    #[derive(Debug, Clone)]
    pub struct RemoteManagementClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl RemoteManagementClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
    ...
    impl<T> RemoteManagementClient<T>
    where
        T: tonic::client::GrpcService<tonic::body::Body>,
        T::Error: Into<StdError>,
        T::ResponseBody: Body<Data = Bytes> + std::marker::Send + 'static,
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> RemoteManagementClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            <T as tonic::codegen::Service<http::Request<tonic::body::Body>>>::Error:
                Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            RemoteManagementClient::new(InterceptedService::new(inner, interceptor))
        }
        /// Compress requests with the given encoding.
        ///
        /// This requires the server to support it otherwise it might respond with an
        ...
        pub async fn create_remote(
            &mut self,
            request: impl tonic::IntoRequest<super::CreateRemoteRequest>,
        ) -> std::result::Result<tonic::Response<super::Remote>, tonic::Status> {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
            let codec = tonic_prost::ProstCodec::default();
        ...
        ) -> std::result::Result<tonic::Response<super::ListRemotesResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
...
/// Generated server implementations.
pub mod remote_management_server {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with RemoteManagementServer.
    #[async_trait]
    pub trait RemoteManagement: std::marker::Send + std::marker::Sync + 'static {
        async fn create_remote(
            &self,
            request: tonic::Request<super::CreateRemoteRequest>,
        ) -> std::result::Result<tonic::Response<super::Remote>, tonic::Status>;
    ...
    #[derive(Debug)]
    pub struct RemoteManagementServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> RemoteManagementServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for RemoteManagementServer<T>
    where
        T: RemoteManagement,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/gestalt.provider.v1.RemoteManagement/CreateRemote" => {
                    #[allow(non_camel_case_types)]
                    struct CreateRemoteSvc<T: RemoteManagement>(pub Arc<T>);
                    impl<T: RemoteManagement>
                        tonic::server::UnaryService<super::CreateRemoteRequest>
                        for CreateRemoteSvc<T>
                    {
                        type Response = super::Remote;
                        type Future = BoxFuture<tonic::Response<Self::Response>, tonic::Status>;
                        fn call(
                            &mut self,
                            request: tonic::Request<super::CreateRemoteRequest>,
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RemoteManagement>::create_remote(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CreateRemoteSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/gestalt.provider.v1.RemoteManagement/ListRemotes" => {
                    #[allow(non_camel_case_types)]
                    struct ListRemotesSvc<T: RemoteManagement>(pub Arc<T>);
                    impl<T: RemoteManagement> tonic::server::UnaryService<super::ListRemotesRequest>
                        for ListRemotesSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RemoteManagement>::list_remotes(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/gestalt.provider.v1.RemoteManagement/DeleteRemote" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteRemoteSvc<T: RemoteManagement>(pub Arc<T>);
                    impl<T: RemoteManagement>
                        ...
                        for DeleteRemoteSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RemoteManagement>::delete_remote(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for RemoteManagementServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "gestalt.provider.v1.RemoteManagement";
    impl<T> tonic::server::NamedService for RemoteManagementServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
pub mod registration_lifecycle_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::*;
    #[derive(Debug, Clone)]
    pub struct RegistrationLifecycleClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl RegistrationLifecycleClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
    ...
    impl<T> RegistrationLifecycleClient<T>
    where
        T: tonic::client::GrpcService<tonic::body::Body>,
        T::Error: Into<StdError>,
        T::ResponseBody: Body<Data = Bytes> + std::marker::Send + 'static,
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> RegistrationLifecycleClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            <T as tonic::codegen::Service<http::Request<tonic::body::Body>>>::Error:
                Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            RegistrationLifecycleClient::new(InterceptedService::new(inner, interceptor))
        }
        /// Compress requests with the given encoding.
        ///
        /// This requires the server to support it otherwise it might respond with an
        ...
        pub async fn check(
            &mut self,
            request: impl tonic::IntoRequest<super::RegistrationCheckRequest>,
        ) -> std::result::Result<tonic::Response<super::RegistrationCheckResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
            ...
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "gestalt.provider.v1.RegistrationLifecycle",
                "Check",
            ));
            self.inner.unary(req, path, codec).await
        }
...
/// Generated server implementations.
pub mod registration_lifecycle_server {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with RegistrationLifecycleServer.
    #[async_trait]
    pub trait RegistrationLifecycle: std::marker::Send + std::marker::Sync + 'static {
        async fn check(
            &self,
            request: tonic::Request<super::RegistrationCheckRequest>,
        ) -> std::result::Result<tonic::Response<super::RegistrationCheckResponse>, tonic::Status>;
    }
    #[derive(Debug)]
    pub struct RegistrationLifecycleServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> RegistrationLifecycleServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for RegistrationLifecycleServer<T>
    where
        T: RegistrationLifecycle,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        type Response = http::Response<tonic::body::Body>;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/gestalt.provider.v1.RegistrationLifecycle/Check" => {
                    #[allow(non_camel_case_types)]
                    struct CheckSvc<T: RegistrationLifecycle>(pub Arc<T>);
                    impl<T: RegistrationLifecycle>
                        tonic::server::UnaryService<super::RegistrationCheckRequest>
                        for CheckSvc<T>
                    {
                        type Response = super::RegistrationCheckResponse;
                        type Future = BoxFuture<tonic::Response<Self::Response>, tonic::Status>;
                        fn call(
                            &mut self,
                            request: tonic::Request<super::RegistrationCheckRequest>,
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RegistrationLifecycle>::check(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for RegistrationLifecycleServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "gestalt.provider.v1.RegistrationLifecycle";
    impl<T> tonic::server::NamedService for RegistrationLifecycleServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
