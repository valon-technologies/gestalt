...
pub mod model_provider_client {
    ...
    ///
    #[derive(Debug, Clone)]
    pub struct ModelProviderClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl ModelProviderClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> ModelProviderClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            ModelProviderClient::new(InterceptedService::new(inner, interceptor))
        }
        /// Compress requests with the given encoding.
        ///
        /// This requires the server to support it otherwise it might respond with an
        ...
        pub async fn generate(
            &mut self,
            request: impl tonic::IntoRequest<super::GenerateModelRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GenerateModelResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("gestalt.provider.v1.ModelProvider", "Generate"),
                );
            self.inner.unary(req, path, codec).await
        }
        ///
        pub async fn get_capabilities(
            &mut self,
            request: impl tonic::IntoRequest<super::GetModelProviderCapabilitiesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ModelProviderCapabilities>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "gestalt.provider.v1.ModelProvider",
                        "GetCapabilities",
                    ),
                );
            self.inner.unary(req, path, codec).await
...
pub mod model_provider_server {
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with ModelProviderServer.
    #[async_trait]
    pub trait ModelProvider: std::marker::Send + std::marker::Sync + 'static {
        ///
        async fn generate(
            &self,
            request: tonic::Request<super::GenerateModelRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GenerateModelResponse>,
            tonic::Status,
        >;
        ...
        async fn get_capabilities(
            &self,
            request: tonic::Request<super::GetModelProviderCapabilitiesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ModelProviderCapabilities>,
            tonic::Status,
        >;
    ...
    ///
    #[derive(Debug)]
    pub struct ModelProviderServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for ModelProviderServer<T>
    where
        T: ModelProvider,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/gestalt.provider.v1.ModelProvider/Generate" => {
                    #[allow(non_camel_case_types)]
                    struct GenerateSvc<T: ModelProvider>(pub Arc<T>);
                    impl<
                        T: ModelProvider,
                    > tonic::server::UnaryService<super::GenerateModelRequest>
                    for GenerateSvc<T> {
                        type Response = super::GenerateModelResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ModelProvider>::generate(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/gestalt.provider.v1.ModelProvider/GetCapabilities" => {
                    #[allow(non_camel_case_types)]
                    struct GetCapabilitiesSvc<T: ModelProvider>(pub Arc<T>);
                    impl<
                        T: ModelProvider,
                    > tonic::server::UnaryService<
                        super::GetModelProviderCapabilitiesRequest,
                    > for GetCapabilitiesSvc<T> {
                        type Response = super::ModelProviderCapabilities;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ModelProvider>::get_capabilities(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    impl<T> Clone for ModelProviderServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "gestalt.provider.v1.ModelProvider";
    impl<T> tonic::server::NamedService for ModelProviderServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
pub mod model_manager_host_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    ///
    #[derive(Debug, Clone)]
    pub struct ModelManagerHostClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl ModelManagerHostClient<tonic::transport::Channel> {
        /// Attempt to create a new client by connecting to a given endpoint.
        pub async fn connect<D>(dst: D) -> Result<Self, tonic::transport::Error>
        where
            D: TryInto<tonic::transport::Endpoint>,
    ...
    impl<T> ModelManagerHostClient<T>
    where
        T: tonic::client::GrpcService<tonic::body::Body>,
        T::Error: Into<StdError>,
        T::ResponseBody: Body<Data = Bytes> + std::marker::Send + 'static,
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> ModelManagerHostClient<InterceptedService<T, F>>
        where
            F: tonic::service::Interceptor,
            T::ResponseBody: Default,
            T: tonic::codegen::Service<
            ...
            >>::Error: Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            ModelManagerHostClient::new(InterceptedService::new(inner, interceptor))
        }
        /// Compress requests with the given encoding.
        ///
        /// This requires the server to support it otherwise it might respond with an
        ...
        pub async fn generate(
            &mut self,
            request: impl tonic::IntoRequest<super::ModelManagerGenerateRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GenerateModelResponse>,
            tonic::Status,
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("gestalt.provider.v1.ModelManagerHost", "Generate"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
/// Generated server implementations.
pub mod model_manager_host_server {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with ModelManagerHostServer.
    #[async_trait]
    pub trait ModelManagerHost: std::marker::Send + std::marker::Sync + 'static {
        ///
        async fn generate(
            &self,
            request: tonic::Request<super::ModelManagerGenerateRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GenerateModelResponse>,
            tonic::Status,
        >;
    ...
    ///
    #[derive(Debug)]
    pub struct ModelManagerHostServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> ModelManagerHostServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for ModelManagerHostServer<T>
    where
        T: ModelManagerHost,
        B: Body + std::marker::Send + 'static,
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/gestalt.provider.v1.ModelManagerHost/Generate" => {
                    #[allow(non_camel_case_types)]
                    struct GenerateSvc<T: ModelManagerHost>(pub Arc<T>);
                    impl<
                        T: ModelManagerHost,
                    > tonic::server::UnaryService<super::ModelManagerGenerateRequest>
                    for GenerateSvc<T> {
                        type Response = super::GenerateModelResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ModelManagerHost>::generate(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for ModelManagerHostServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "gestalt.provider.v1.ModelManagerHost";
    impl<T> tonic::server::NamedService for ModelManagerHostServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
/// Generated client implementations.
...
pub mod workflow_manager_host_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn create_definition(
            &mut self,
            request: impl tonic::IntoRequest<
                super::WorkflowManagerCreateDefinitionRequest,
            >,
        ) -> std::result::Result<
        ...
        pub async fn update_definition(
            &mut self,
            request: impl tonic::IntoRequest<
                super::WorkflowManagerUpdateDefinitionRequest,
            >,
        ) -> std::result::Result<
            tonic::Response<super::ManagedWorkflowDefinition>,
            tonic::Status,
        ...
        pub async fn create_schedule(
            ...
            tonic::Response<super::ManagedWorkflowSchedule>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn create_event_trigger(
            ...
            tonic::Response<super::ManagedWorkflowEventTrigger>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn get_event_trigger(
            &mut self,
            request: impl tonic::IntoRequest<
                super::WorkflowManagerGetEventTriggerRequest,
            >,
        ) -> std::result::Result<
            tonic::Response<super::ManagedWorkflowEventTrigger>,
            tonic::Status,
        ...
        pub async fn pause_event_trigger(
            &mut self,
            request: impl tonic::IntoRequest<
                super::WorkflowManagerPauseEventTriggerRequest,
            >,
        ) -> std::result::Result<
            tonic::Response<super::ManagedWorkflowEventTrigger>,
            tonic::Status,
...
pub mod workflow_manager_host_server {
    ...
    pub trait WorkflowManagerHost: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn create_definition(
            &self,
            request: tonic::Request<super::WorkflowManagerCreateDefinitionRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ManagedWorkflowDefinition>,
            tonic::Status,
        >;
        ...
        async fn update_definition(
            &self,
            request: tonic::Request<super::WorkflowManagerUpdateDefinitionRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ManagedWorkflowDefinition>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/gestalt.provider.v1.WorkflowManagerHost/CreateDefinition" => {
                    #[allow(non_camel_case_types)]
                    struct CreateDefinitionSvc<T: WorkflowManagerHost>(pub Arc<T>);
                    impl<
                        T: WorkflowManagerHost,
                    > tonic::server::UnaryService<
                        super::WorkflowManagerCreateDefinitionRequest,
                    > for CreateDefinitionSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowManagerHost>::create_definition(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/gestalt.provider.v1.WorkflowManagerHost/UpdateDefinition" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateDefinitionSvc<T: WorkflowManagerHost>(pub Arc<T>);
                    impl<
                        T: WorkflowManagerHost,
                    > tonic::server::UnaryService<
                        super::WorkflowManagerUpdateDefinitionRequest,
                    > for UpdateDefinitionSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowManagerHost>::update_definition(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/gestalt.provider.v1.WorkflowManagerHost/CreateSchedule" => {
                    ...
                    impl<
                        T: WorkflowManagerHost,
                    > tonic::server::UnaryService<
                        super::WorkflowManagerCreateScheduleRequest,
                    > for CreateScheduleSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowManagerHost>::create_schedule(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/gestalt.provider.v1.WorkflowManagerHost/GetSchedule" => {
                    ...
                    impl<
                        T: WorkflowManagerHost,
                    > tonic::server::UnaryService<
                        super::WorkflowManagerGetScheduleRequest,
                    > for GetScheduleSvc<T> {
                        type Response = super::ManagedWorkflowSchedule;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowManagerHost>::get_schedule(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/gestalt.provider.v1.WorkflowManagerHost/UpdateSchedule" => {
                    ...
                    impl<
                        T: WorkflowManagerHost,
                    > tonic::server::UnaryService<
                        super::WorkflowManagerUpdateScheduleRequest,
                    > for UpdateScheduleSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowManagerHost>::update_schedule(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/gestalt.provider.v1.WorkflowManagerHost/DeleteSchedule" => {
                    ...
                    impl<
                        T: WorkflowManagerHost,
                    > tonic::server::UnaryService<
                        super::WorkflowManagerDeleteScheduleRequest,
                    > for DeleteScheduleSvc<T> {
                        type Response = ();
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowManagerHost>::delete_schedule(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/gestalt.provider.v1.WorkflowManagerHost/PauseSchedule" => {
                    ...
                    impl<
                        T: WorkflowManagerHost,
                    > tonic::server::UnaryService<
                        super::WorkflowManagerPauseScheduleRequest,
                    > for PauseScheduleSvc<T> {
                        type Response = super::ManagedWorkflowSchedule;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowManagerHost>::pause_schedule(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/gestalt.provider.v1.WorkflowManagerHost/ResumeSchedule" => {
                    ...
                    impl<
                        T: WorkflowManagerHost,
                    > tonic::server::UnaryService<
                        super::WorkflowManagerResumeScheduleRequest,
                    > for ResumeScheduleSvc<T> {
                        type Response = super::ManagedWorkflowSchedule;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowManagerHost>::resume_schedule(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/gestalt.provider.v1.WorkflowManagerHost/CreateEventTrigger" => {
                    ...
                    > for CreateEventTriggerSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowManagerHost>::create_event_trigger(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/gestalt.provider.v1.WorkflowManagerHost/GetEventTrigger" => {
                    ...
                    > for GetEventTriggerSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowManagerHost>::get_event_trigger(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/gestalt.provider.v1.WorkflowManagerHost/UpdateEventTrigger" => {
                    ...
                    > for UpdateEventTriggerSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowManagerHost>::update_event_trigger(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/gestalt.provider.v1.WorkflowManagerHost/DeleteEventTrigger" => {
                    ...
                    > for DeleteEventTriggerSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowManagerHost>::delete_event_trigger(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/gestalt.provider.v1.WorkflowManagerHost/PauseEventTrigger" => {
                    ...
                    > for PauseEventTriggerSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowManagerHost>::pause_event_trigger(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/gestalt.provider.v1.WorkflowManagerHost/ResumeEventTrigger" => {
                    ...
                    > for ResumeEventTriggerSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowManagerHost>::resume_event_trigger(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/gestalt.provider.v1.WorkflowManagerHost/PublishEvent" => {
                    ...
                    impl<
                        T: WorkflowManagerHost,
                    > tonic::server::UnaryService<
                        super::WorkflowManagerPublishEventRequest,
                    > for PublishEventSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowManagerHost>::publish_event(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
