...
*/
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("gestalt.provider.v1.IntegrationProvider", "Execute"),
                );
            self.inner.unary(req, path, codec).await
        }
        ///
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/gestalt.provider.v1.IntegrationProvider/GetMetadata" => {
                    ...
                    impl<T: IntegrationProvider> tonic::server::UnaryService<()>
                    for GetMetadataSvc<T> {
                        ...
                        fn call(&mut self, request: tonic::Request<()>) -> Self::Future {
                            ...
                            let fut = async move {
                                <T as IntegrationProvider>::get_metadata(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/gestalt.provider.v1.IntegrationProvider/StartProvider" => {
                    ...
                    for StartProviderSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as IntegrationProvider>::start_provider(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/gestalt.provider.v1.IntegrationProvider/ResolveHTTPSubject" => {
                    ...
                    for ResolveHTTPSubjectSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as IntegrationProvider>::resolve_http_subject(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/gestalt.provider.v1.IntegrationProvider/GetSessionCatalog" => {
                    ...
                    for GetSessionCatalogSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as IntegrationProvider>::get_session_catalog(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/gestalt.provider.v1.IntegrationProvider/PostConnect" => {
                    ...
                    for PostConnectSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as IntegrationProvider>::post_connect(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
...
pub mod plugin_invoker_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("gestalt.provider.v1.PluginInvoker", "Invoke"));
            self.inner.unary(req, path, codec).await
        }
        ///
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("gestalt.provider.v1.PluginInvoker", "InvokeGraphQL"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/gestalt.provider.v1.PluginInvoker/ExchangeInvocationToken" => {
                    ...
                    for ExchangeInvocationTokenSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PluginInvoker>::exchange_invocation_token(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/gestalt.provider.v1.PluginInvoker/Invoke" => {
                    ...
                    impl<
                        T: PluginInvoker,
                    > tonic::server::UnaryService<super::PluginInvokeRequest>
                    for InvokeSvc<T> {
                        type Response = super::OperationResult;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PluginInvoker>::invoke(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
...
pub mod agent_manager_host_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_session(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("gestalt.provider.v1.AgentManagerHost", "GetSession"),
                );
            self.inner.unary(req, path, codec).await
        }
        ///
        ...
        pub async fn create_turn(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("gestalt.provider.v1.AgentManagerHost", "CreateTurn"),
                );
            self.inner.unary(req, path, codec).await
        }
        ///
        pub async fn get_turn(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("gestalt.provider.v1.AgentManagerHost", "GetTurn"),
                );
            self.inner.unary(req, path, codec).await
        }
        ///
        pub async fn list_turns(
            ...
            tonic::Response<super::AgentManagerListTurnsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("gestalt.provider.v1.AgentManagerHost", "ListTurns"),
                );
            self.inner.unary(req, path, codec).await
        }
        ///
        pub async fn cancel_turn(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("gestalt.provider.v1.AgentManagerHost", "CancelTurn"),
                );
            self.inner.unary(req, path, codec).await
        }
        ///
        ...
        pub async fn resolve_interaction(
            &mut self,
            request: impl tonic::IntoRequest<
                super::AgentManagerResolveInteractionRequest,
            >,
        ) -> std::result::Result<
            tonic::Response<super::AgentInteraction>,
            tonic::Status,
            ...
            match req.uri().path() {
                "/gestalt.provider.v1.AgentManagerHost/CreateSession" => {
                    ...
                    impl<
                        T: AgentManagerHost,
                    > tonic::server::UnaryService<
                        super::AgentManagerCreateSessionRequest,
                    > for CreateSessionSvc<T> {
                        type Response = super::AgentSession;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AgentManagerHost>::create_session(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/gestalt.provider.v1.AgentManagerHost/ListSessions" => {
                    ...
                    for ListSessionsSvc<T> {
                        ...
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::AgentManagerListSessionsRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AgentManagerHost>::list_sessions(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/gestalt.provider.v1.AgentManagerHost/UpdateSession" => {
                    ...
                    impl<
                        T: AgentManagerHost,
                    > tonic::server::UnaryService<
                        super::AgentManagerUpdateSessionRequest,
                    > for UpdateSessionSvc<T> {
                        type Response = super::AgentSession;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AgentManagerHost>::update_session(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/gestalt.provider.v1.AgentManagerHost/ListTurnEvents" => {
                    ...
                    impl<
                        T: AgentManagerHost,
                    > tonic::server::UnaryService<
                        super::AgentManagerListTurnEventsRequest,
                    > for ListTurnEventsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AgentManagerHost>::list_turn_events(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/gestalt.provider.v1.AgentManagerHost/ListInteractions" => {
                    ...
                    impl<
                        T: AgentManagerHost,
                    > tonic::server::UnaryService<
                        super::AgentManagerListInteractionsRequest,
                    > for ListInteractionsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AgentManagerHost>::list_interactions(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/gestalt.provider.v1.AgentManagerHost/ResolveInteraction" => {
                    ...
                    > for ResolveInteractionSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AgentManagerHost>::resolve_interaction(
                                        &inner,
                                        request,
                                    )
                                    .await
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/gestalt.provider.v1.AuthorizationProvider/EffectiveSearchResources" => {
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = EffectiveSearchResourcesSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/gestalt.provider.v1.AuthorizationProvider/EffectiveSearchSubjects" => {
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = EffectiveSearchSubjectsSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/gestalt.provider.v1.AuthorizationProvider/Expand" => {
                    ...
                    for ExpandSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AuthorizationProvider>::expand(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
...
pub mod plugin_runtime_log_host_server {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>>
    for PluginRuntimeLogHostServer<T>
    where
                ...
                "/gestalt.provider.v1.PluginRuntimeLogHost/AppendLogs" => {
                    ...
                    for AppendLogsSvc<T> {
                        ...
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::AppendPluginRuntimeLogsRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PluginRuntimeLogHost>::append_logs(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
...
pub mod plugin_runtime_provider_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_support(
            ...
            tonic::Response<super::PluginRuntimeSupport>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn start_session(
            ...
            tonic::Response<super::PluginRuntimeSession>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
pub mod plugin_runtime_provider_server {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>>
    for PluginRuntimeProviderServer<T>
    where
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/gestalt.provider.v1.PluginRuntimeProvider/GetSupport" => {
                    ...
                    impl<T: PluginRuntimeProvider> tonic::server::UnaryService<()>
                    for GetSupportSvc<T> {
                        ...
                        fn call(&mut self, request: tonic::Request<()>) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PluginRuntimeProvider>::get_support(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/gestalt.provider.v1.PluginRuntimeProvider/StartSession" => {
                    ...
                    impl<
                        T: PluginRuntimeProvider,
                    > tonic::server::UnaryService<
                        super::StartPluginRuntimeSessionRequest,
                    > for StartSessionSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PluginRuntimeProvider>::start_session(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/gestalt.provider.v1.PluginRuntimeProvider/GetSession" => {
                    ...
                    for GetSessionSvc<T> {
                        ...
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::GetPluginRuntimeSessionRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PluginRuntimeProvider>::get_session(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/gestalt.provider.v1.PluginRuntimeProvider/ListSessions" => {
                    ...
                    impl<
                        T: PluginRuntimeProvider,
                    > tonic::server::UnaryService<
                        super::ListPluginRuntimeSessionsRequest,
                    > for ListSessionsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PluginRuntimeProvider>::list_sessions(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/gestalt.provider.v1.PluginRuntimeProvider/StopSession" => {
                    ...
                    for StopSessionSvc<T> {
                        ...
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::StopPluginRuntimeSessionRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PluginRuntimeProvider>::stop_session(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/gestalt.provider.v1.PluginRuntimeProvider/PrepareWorkspace" => {
                    ...
                    impl<
                        T: PluginRuntimeProvider,
                    > tonic::server::UnaryService<
                        super::PreparePluginRuntimeWorkspaceRequest,
                    > for PrepareWorkspaceSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PluginRuntimeProvider>::prepare_workspace(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/gestalt.provider.v1.PluginRuntimeProvider/RemoveWorkspace" => {
                    ...
                    impl<
                        T: PluginRuntimeProvider,
                    > tonic::server::UnaryService<
                        super::RemovePluginRuntimeWorkspaceRequest,
                    > for RemoveWorkspaceSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PluginRuntimeProvider>::remove_workspace(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/gestalt.provider.v1.PluginRuntimeProvider/StartPlugin" => {
                    ...
                    for StartPluginSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PluginRuntimeProvider>::start_plugin(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
...
pub mod workflow_provider_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn plan_workflow(
            &mut self,
            request: impl tonic::IntoRequest<super::PlanWorkflowRequest>,
        ) -> std::result::Result<
            tonic::Response<super::PlanWorkflowResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        ///
        pub async fn apply_workflow_deployment(
            &mut self,
            request: impl tonic::IntoRequest<super::ApplyWorkflowDeploymentRequest>,
        ) -> std::result::Result<
            tonic::Response<super::WorkflowDeployment>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        ///
        pub async fn get_workflow_deployment(
            &mut self,
            request: impl tonic::IntoRequest<super::GetWorkflowDeploymentRequest>,
        ) -> std::result::Result<
            tonic::Response<super::WorkflowDeployment>,
            tonic::Status,
        > {
        ...
        ///
        pub async fn list_workflow_deployments(
            &mut self,
            request: impl tonic::IntoRequest<super::ListWorkflowDeploymentsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListWorkflowDeploymentsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        ///
        pub async fn delete_workflow_deployment(
            &mut self,
            request: impl tonic::IntoRequest<super::DeleteWorkflowDeploymentRequest>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status> {
            self.inner
                .ready()
                .await
        ...
        ///
        pub async fn set_workflow_deployment_paused(
            &mut self,
            request: impl tonic::IntoRequest<super::SetWorkflowDeploymentPausedRequest>,
        ) -> std::result::Result<
            tonic::Response<super::WorkflowDeployment>,
            tonic::Status,
        > {
        ...
        ///
        pub async fn set_workflow_activation_paused(
            &mut self,
            request: impl tonic::IntoRequest<super::SetWorkflowActivationPausedRequest>,
        ) -> std::result::Result<
            tonic::Response<super::WorkflowDeployment>,
            tonic::Status,
        > {
        ...
        ///
        pub async fn signal_workflow_run(
            &mut self,
            request: impl tonic::IntoRequest<super::SignalWorkflowRunRequest>,
        ) -> std::result::Result<
            tonic::Response<super::WorkflowRunSignal>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        ///
        pub async fn signal_or_start_workflow_run(
            &mut self,
            request: impl tonic::IntoRequest<super::SignalOrStartWorkflowRunRequest>,
        ) -> std::result::Result<
            tonic::Response<super::WorkflowRunSignal>,
            tonic::Status,
        > {
        ...
        ///
        pub async fn deliver_workflow_event(
            &mut self,
            request: impl tonic::IntoRequest<super::DeliverWorkflowEventRequest>,
        ) -> std::result::Result<
            tonic::Response<super::DeliverWorkflowEventResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        ///
        pub async fn get_workflow_run_events(
            &mut self,
            request: impl tonic::IntoRequest<super::GetWorkflowRunEventsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListWorkflowRunEventsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        ///
        pub async fn get_workflow_run_output(
            &mut self,
            request: impl tonic::IntoRequest<super::GetWorkflowRunOutputRequest>,
        ) -> std::result::Result<
            tonic::Response<super::WorkflowRunOutput>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
pub mod workflow_provider_server {
    ...
    pub trait WorkflowProvider: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn plan_workflow(
            &self,
            request: tonic::Request<super::PlanWorkflowRequest>,
        ) -> std::result::Result<
            tonic::Response<super::PlanWorkflowResponse>,
            tonic::Status,
        >;
        ...
        async fn apply_workflow_deployment(
            &self,
            request: tonic::Request<super::ApplyWorkflowDeploymentRequest>,
        ) -> std::result::Result<
            tonic::Response<super::WorkflowDeployment>,
            tonic::Status,
        >;
        ...
        async fn get_workflow_deployment(
            &self,
            request: tonic::Request<super::GetWorkflowDeploymentRequest>,
        ) -> std::result::Result<
            tonic::Response<super::WorkflowDeployment>,
            tonic::Status,
        >;
        ...
        async fn list_workflow_deployments(
            &self,
            request: tonic::Request<super::ListWorkflowDeploymentsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListWorkflowDeploymentsResponse>,
            tonic::Status,
        >;
        ...
        async fn delete_workflow_deployment(
            &self,
            request: tonic::Request<super::DeleteWorkflowDeploymentRequest>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status>;
        ///
        async fn set_workflow_deployment_paused(
            &self,
            request: tonic::Request<super::SetWorkflowDeploymentPausedRequest>,
        ) -> std::result::Result<
            tonic::Response<super::WorkflowDeployment>,
            tonic::Status,
        >;
        ...
        async fn set_workflow_activation_paused(
            &self,
            request: tonic::Request<super::SetWorkflowActivationPausedRequest>,
        ) -> std::result::Result<
            tonic::Response<super::WorkflowDeployment>,
            tonic::Status,
        >;
        ...
        async fn signal_workflow_run(
            &self,
            request: tonic::Request<super::SignalWorkflowRunRequest>,
        ) -> std::result::Result<
            tonic::Response<super::WorkflowRunSignal>,
            tonic::Status,
        >;
        ...
        async fn signal_or_start_workflow_run(
            &self,
            request: tonic::Request<super::SignalOrStartWorkflowRunRequest>,
        ) -> std::result::Result<
            tonic::Response<super::WorkflowRunSignal>,
            tonic::Status,
        >;
        ...
        async fn deliver_workflow_event(
            &self,
            request: tonic::Request<super::DeliverWorkflowEventRequest>,
        ) -> std::result::Result<
            tonic::Response<super::DeliverWorkflowEventResponse>,
            tonic::Status,
        >;
        ...
        async fn get_workflow_run_events(
            &self,
            request: tonic::Request<super::GetWorkflowRunEventsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListWorkflowRunEventsResponse>,
            tonic::Status,
        >;
        ...
        async fn get_workflow_run_output(
            &self,
            request: tonic::Request<super::GetWorkflowRunOutputRequest>,
        ) -> std::result::Result<
            tonic::Response<super::WorkflowRunOutput>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/gestalt.provider.v1.WorkflowProvider/PlanWorkflow" => {
                    #[allow(non_camel_case_types)]
                    struct PlanWorkflowSvc<T: WorkflowProvider>(pub Arc<T>);
                    impl<
                        T: WorkflowProvider,
                    > tonic::server::UnaryService<super::PlanWorkflowRequest>
                    for PlanWorkflowSvc<T> {
                        type Response = super::PlanWorkflowResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowProvider>::plan_workflow(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = PlanWorkflowSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/gestalt.provider.v1.WorkflowProvider/ApplyWorkflowDeployment" => {
                    #[allow(non_camel_case_types)]
                    struct ApplyWorkflowDeploymentSvc<T: WorkflowProvider>(pub Arc<T>);
                    impl<
                        T: WorkflowProvider,
                    > tonic::server::UnaryService<super::ApplyWorkflowDeploymentRequest>
                    for ApplyWorkflowDeploymentSvc<T> {
                        type Response = super::WorkflowDeployment;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::ApplyWorkflowDeploymentRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowProvider>::apply_workflow_deployment(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ApplyWorkflowDeploymentSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/gestalt.provider.v1.WorkflowProvider/GetWorkflowDeployment" => {
                    #[allow(non_camel_case_types)]
                    struct GetWorkflowDeploymentSvc<T: WorkflowProvider>(pub Arc<T>);
                    impl<
                        T: WorkflowProvider,
                    > tonic::server::UnaryService<super::GetWorkflowDeploymentRequest>
                    for GetWorkflowDeploymentSvc<T> {
                        type Response = super::WorkflowDeployment;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowProvider>::get_workflow_deployment(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetWorkflowDeploymentSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/gestalt.provider.v1.WorkflowProvider/ListWorkflowDeployments" => {
                    #[allow(non_camel_case_types)]
                    struct ListWorkflowDeploymentsSvc<T: WorkflowProvider>(pub Arc<T>);
                    impl<
                        T: WorkflowProvider,
                    > tonic::server::UnaryService<super::ListWorkflowDeploymentsRequest>
                    for ListWorkflowDeploymentsSvc<T> {
                        type Response = super::ListWorkflowDeploymentsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::ListWorkflowDeploymentsRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowProvider>::list_workflow_deployments(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListWorkflowDeploymentsSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/gestalt.provider.v1.WorkflowProvider/DeleteWorkflowDeployment" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteWorkflowDeploymentSvc<T: WorkflowProvider>(pub Arc<T>);
                    impl<
                        T: WorkflowProvider,
                    > tonic::server::UnaryService<super::DeleteWorkflowDeploymentRequest>
                    for DeleteWorkflowDeploymentSvc<T> {
                        type Response = ();
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::DeleteWorkflowDeploymentRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowProvider>::delete_workflow_deployment(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DeleteWorkflowDeploymentSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/gestalt.provider.v1.WorkflowProvider/SetWorkflowDeploymentPaused" => {
                    #[allow(non_camel_case_types)]
                    struct SetWorkflowDeploymentPausedSvc<T: WorkflowProvider>(
                        pub Arc<T>,
                    );
                    impl<
                        T: WorkflowProvider,
                    > tonic::server::UnaryService<
                        super::SetWorkflowDeploymentPausedRequest,
                    > for SetWorkflowDeploymentPausedSvc<T> {
                        type Response = super::WorkflowDeployment;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowProvider>::set_workflow_deployment_paused(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = SetWorkflowDeploymentPausedSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/gestalt.provider.v1.WorkflowProvider/SetWorkflowActivationPaused" => {
                    #[allow(non_camel_case_types)]
                    struct SetWorkflowActivationPausedSvc<T: WorkflowProvider>(
                        pub Arc<T>,
                    );
                    impl<
                        T: WorkflowProvider,
                    > tonic::server::UnaryService<
                        super::SetWorkflowActivationPausedRequest,
                    > for SetWorkflowActivationPausedSvc<T> {
                        type Response = super::WorkflowDeployment;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowProvider>::set_workflow_activation_paused(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = SetWorkflowActivationPausedSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/gestalt.provider.v1.WorkflowProvider/StartWorkflowRun" => {
                    #[allow(non_camel_case_types)]
                    struct StartWorkflowRunSvc<T: WorkflowProvider>(pub Arc<T>);
                    impl<
                        T: WorkflowProvider,
                    ...
                    for StartWorkflowRunSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowProvider>::start_workflow_run(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/gestalt.provider.v1.WorkflowProvider/SignalWorkflowRun" => {
                    #[allow(non_camel_case_types)]
                    struct SignalWorkflowRunSvc<T: WorkflowProvider>(pub Arc<T>);
                    impl<
                        T: WorkflowProvider,
                    > tonic::server::UnaryService<super::SignalWorkflowRunRequest>
                    for SignalWorkflowRunSvc<T> {
                        type Response = super::WorkflowRunSignal;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowProvider>::signal_workflow_run(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = SignalWorkflowRunSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/gestalt.provider.v1.WorkflowProvider/SignalOrStartWorkflowRun" => {
                    #[allow(non_camel_case_types)]
                    struct SignalOrStartWorkflowRunSvc<T: WorkflowProvider>(pub Arc<T>);
                    impl<
                        T: WorkflowProvider,
                    > tonic::server::UnaryService<super::SignalOrStartWorkflowRunRequest>
                    for SignalOrStartWorkflowRunSvc<T> {
                        type Response = super::WorkflowRunSignal;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::SignalOrStartWorkflowRunRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowProvider>::signal_or_start_workflow_run(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = SignalOrStartWorkflowRunSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/gestalt.provider.v1.WorkflowProvider/CancelWorkflowRun" => {
                    #[allow(non_camel_case_types)]
                    struct CancelWorkflowRunSvc<T: WorkflowProvider>(pub Arc<T>);
                    impl<
                        T: WorkflowProvider,
                    ...
                    for CancelWorkflowRunSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowProvider>::cancel_workflow_run(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/gestalt.provider.v1.WorkflowProvider/DeliverWorkflowEvent" => {
                    #[allow(non_camel_case_types)]
                    struct DeliverWorkflowEventSvc<T: WorkflowProvider>(pub Arc<T>);
                    impl<
                        T: WorkflowProvider,
                    > tonic::server::UnaryService<super::DeliverWorkflowEventRequest>
                    for DeliverWorkflowEventSvc<T> {
                        type Response = super::DeliverWorkflowEventResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowProvider>::deliver_workflow_event(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = DeliverWorkflowEventSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/gestalt.provider.v1.WorkflowProvider/GetWorkflowRun" => {
                    #[allow(non_camel_case_types)]
                    struct GetWorkflowRunSvc<T: WorkflowProvider>(pub Arc<T>);
                    impl<
                        T: WorkflowProvider,
                    ...
                    for GetWorkflowRunSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowProvider>::get_workflow_run(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/gestalt.provider.v1.WorkflowProvider/ListWorkflowRuns" => {
                    #[allow(non_camel_case_types)]
                    struct ListWorkflowRunsSvc<T: WorkflowProvider>(pub Arc<T>);
                    impl<
                        T: WorkflowProvider,
                    ...
                    for ListWorkflowRunsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowProvider>::list_workflow_runs(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/gestalt.provider.v1.WorkflowProvider/GetWorkflowRunEvents" => {
                    #[allow(non_camel_case_types)]
                    struct GetWorkflowRunEventsSvc<T: WorkflowProvider>(pub Arc<T>);
                    impl<
                        T: WorkflowProvider,
                    > tonic::server::UnaryService<super::GetWorkflowRunEventsRequest>
                    for GetWorkflowRunEventsSvc<T> {
                        type Response = super::ListWorkflowRunEventsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowProvider>::get_workflow_run_events(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetWorkflowRunEventsSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/gestalt.provider.v1.WorkflowProvider/GetWorkflowRunOutput" => {
                    #[allow(non_camel_case_types)]
                    struct GetWorkflowRunOutputSvc<T: WorkflowProvider>(pub Arc<T>);
                    impl<
                        T: WorkflowProvider,
                    > tonic::server::UnaryService<super::GetWorkflowRunOutputRequest>
                    for GetWorkflowRunOutputSvc<T> {
                        type Response = super::WorkflowRunOutput;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowProvider>::get_workflow_run_output(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetWorkflowRunOutputSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
...
pub mod workflow_host_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        ///
        pub async fn invoke_workflow_action(
            &mut self,
            request: impl tonic::IntoRequest<super::InvokeWorkflowActionRequest>,
        ) -> std::result::Result<
            tonic::Response<super::WorkflowActionResult>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
pub mod workflow_host_server {
    ...
    pub trait WorkflowHost: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn invoke_workflow_action(
            &self,
            request: tonic::Request<super::InvokeWorkflowActionRequest>,
        ) -> std::result::Result<
            tonic::Response<super::WorkflowActionResult>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/gestalt.provider.v1.WorkflowHost/InvokeWorkflowAction" => {
                    #[allow(non_camel_case_types)]
                    struct InvokeWorkflowActionSvc<T: WorkflowHost>(pub Arc<T>);
                    impl<
                        T: WorkflowHost,
                    > tonic::server::UnaryService<super::InvokeWorkflowActionRequest>
                    for InvokeWorkflowActionSvc<T> {
                        type Response = super::WorkflowActionResult;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowHost>::invoke_workflow_action(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = InvokeWorkflowActionSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
...
pub mod workflow_manager_host_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn plan_deployment(
            &mut self,
            request: impl tonic::IntoRequest<super::WorkflowManagerPlanDeploymentRequest>,
        ) -> std::result::Result<
            tonic::Response<super::PlanWorkflowResponse>,
            tonic::Status,
        > {
        ...
        pub async fn apply_deployment(
            &mut self,
            request: impl tonic::IntoRequest<
                super::WorkflowManagerApplyDeploymentRequest,
            >,
        ) -> std::result::Result<
            tonic::Response<super::ManagedWorkflowDeployment>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn get_deployment(
            &mut self,
            request: impl tonic::IntoRequest<super::WorkflowManagerGetDeploymentRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ManagedWorkflowDeployment>,
            tonic::Status,
        > {
        ...
        pub async fn list_deployments(
            &mut self,
            request: impl tonic::IntoRequest<
                super::WorkflowManagerListDeploymentsRequest,
            >,
        ) -> std::result::Result<
            tonic::Response<super::WorkflowManagerListDeploymentsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn delete_deployment(
            &mut self,
            request: impl tonic::IntoRequest<
                super::WorkflowManagerDeleteDeploymentRequest,
            >,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status> {
            self.inner
                .ready()
        ...
        pub async fn set_deployment_paused(
            &mut self,
            request: impl tonic::IntoRequest<
                super::WorkflowManagerSetDeploymentPausedRequest,
            >,
        ) -> std::result::Result<
            tonic::Response<super::ManagedWorkflowDeployment>,
            tonic::Status,
        ...
        pub async fn set_activation_paused(
            &mut self,
            request: impl tonic::IntoRequest<
                super::WorkflowManagerSetActivationPausedRequest,
            >,
        ) -> std::result::Result<
            tonic::Response<super::ManagedWorkflowDeployment>,
            tonic::Status,
        ...
        pub async fn start_run(
            ...
            tonic::Response<super::ManagedWorkflowRun>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn signal_run(
            ...
            tonic::Response<super::ManagedWorkflowRunSignal>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn signal_or_start_run(
            &mut self,
            request: impl tonic::IntoRequest<
                super::WorkflowManagerSignalOrStartRunRequest,
            >,
        ) -> std::result::Result<
            tonic::Response<super::ManagedWorkflowRunSignal>,
            tonic::Status,
        ...
        pub async fn cancel_run(
            &mut self,
            request: impl tonic::IntoRequest<super::WorkflowManagerCancelRunRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ManagedWorkflowRun>,
            tonic::Status,
        > {
        ...
        pub async fn deliver_event(
            &mut self,
            request: impl tonic::IntoRequest<super::WorkflowManagerDeliverEventRequest>,
        ) -> std::result::Result<
            tonic::Response<super::WorkflowManagerDeliverEventResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
pub mod workflow_manager_host_server {
    ...
    pub trait WorkflowManagerHost: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn plan_deployment(
            &self,
            request: tonic::Request<super::WorkflowManagerPlanDeploymentRequest>,
        ) -> std::result::Result<
            tonic::Response<super::PlanWorkflowResponse>,
            tonic::Status,
        >;
        ...
        async fn apply_deployment(
            &self,
            request: tonic::Request<super::WorkflowManagerApplyDeploymentRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ManagedWorkflowDeployment>,
            tonic::Status,
        >;
        ...
        async fn get_deployment(
            &self,
            request: tonic::Request<super::WorkflowManagerGetDeploymentRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ManagedWorkflowDeployment>,
            tonic::Status,
        >;
        ...
        async fn list_deployments(
            &self,
            request: tonic::Request<super::WorkflowManagerListDeploymentsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::WorkflowManagerListDeploymentsResponse>,
            tonic::Status,
        >;
        ...
        async fn delete_deployment(
            &self,
            request: tonic::Request<super::WorkflowManagerDeleteDeploymentRequest>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status>;
        ///
        async fn set_deployment_paused(
            &self,
            request: tonic::Request<super::WorkflowManagerSetDeploymentPausedRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ManagedWorkflowDeployment>,
            tonic::Status,
        >;
        ...
        async fn set_activation_paused(
            &self,
            request: tonic::Request<super::WorkflowManagerSetActivationPausedRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ManagedWorkflowDeployment>,
            tonic::Status,
        >;
        ...
        async fn cancel_run(
            &self,
            request: tonic::Request<super::WorkflowManagerCancelRunRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ManagedWorkflowRun>,
            tonic::Status,
        >;
        ...
        async fn deliver_event(
            &self,
            request: tonic::Request<super::WorkflowManagerDeliverEventRequest>,
        ) -> std::result::Result<
            tonic::Response<super::WorkflowManagerDeliverEventResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/gestalt.provider.v1.WorkflowManagerHost/PlanDeployment" => {
                    #[allow(non_camel_case_types)]
                    struct PlanDeploymentSvc<T: WorkflowManagerHost>(pub Arc<T>);
                    impl<
                        T: WorkflowManagerHost,
                    > tonic::server::UnaryService<
                        super::WorkflowManagerPlanDeploymentRequest,
                    > for PlanDeploymentSvc<T> {
                        type Response = super::PlanWorkflowResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowManagerHost>::plan_deployment(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = PlanDeploymentSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/gestalt.provider.v1.WorkflowManagerHost/ApplyDeployment" => {
                    #[allow(non_camel_case_types)]
                    struct ApplyDeploymentSvc<T: WorkflowManagerHost>(pub Arc<T>);
                    impl<
                        T: WorkflowManagerHost,
                    > tonic::server::UnaryService<
                        super::WorkflowManagerApplyDeploymentRequest,
                    > for ApplyDeploymentSvc<T> {
                        type Response = super::ManagedWorkflowDeployment;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowManagerHost>::apply_deployment(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/gestalt.provider.v1.WorkflowManagerHost/GetDeployment" => {
                    #[allow(non_camel_case_types)]
                    struct GetDeploymentSvc<T: WorkflowManagerHost>(pub Arc<T>);
                    impl<
                        T: WorkflowManagerHost,
                    > tonic::server::UnaryService<
                        super::WorkflowManagerGetDeploymentRequest,
                    > for GetDeploymentSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowManagerHost>::get_deployment(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/gestalt.provider.v1.WorkflowManagerHost/ListDeployments" => {
                    #[allow(non_camel_case_types)]
                    struct ListDeploymentsSvc<T: WorkflowManagerHost>(pub Arc<T>);
                    impl<
                        T: WorkflowManagerHost,
                    > tonic::server::UnaryService<
                        super::WorkflowManagerListDeploymentsRequest,
                    > for ListDeploymentsSvc<T> {
                        type Response = super::WorkflowManagerListDeploymentsResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowManagerHost>::list_deployments(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/gestalt.provider.v1.WorkflowManagerHost/DeleteDeployment" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteDeploymentSvc<T: WorkflowManagerHost>(pub Arc<T>);
                    impl<
                        T: WorkflowManagerHost,
                    > tonic::server::UnaryService<
                        super::WorkflowManagerDeleteDeploymentRequest,
                    > for DeleteDeploymentSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowManagerHost>::delete_deployment(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/gestalt.provider.v1.WorkflowManagerHost/SetDeploymentPaused" => {
                    #[allow(non_camel_case_types)]
                    struct SetDeploymentPausedSvc<T: WorkflowManagerHost>(pub Arc<T>);
                    impl<
                        T: WorkflowManagerHost,
                    > tonic::server::UnaryService<
                        super::WorkflowManagerSetDeploymentPausedRequest,
                    > for SetDeploymentPausedSvc<T> {
                        type Response = super::ManagedWorkflowDeployment;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowManagerHost>::set_deployment_paused(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = SetDeploymentPausedSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/gestalt.provider.v1.WorkflowManagerHost/SetActivationPaused" => {
                    #[allow(non_camel_case_types)]
                    struct SetActivationPausedSvc<T: WorkflowManagerHost>(pub Arc<T>);
                    impl<
                        T: WorkflowManagerHost,
                    > tonic::server::UnaryService<
                        super::WorkflowManagerSetActivationPausedRequest,
                    > for SetActivationPausedSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowManagerHost>::set_activation_paused(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/gestalt.provider.v1.WorkflowManagerHost/StartRun" => {
                    ...
                    for StartRunSvc<T> {
                        ...
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::WorkflowManagerStartRunRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                ...
                "/gestalt.provider.v1.WorkflowManagerHost/SignalRun" => {
                    ...
                    for SignalRunSvc<T> {
                        ...
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::WorkflowManagerSignalRunRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowManagerHost>::signal_run(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/gestalt.provider.v1.WorkflowManagerHost/SignalOrStartRun" => {
                    ...
                    > for SignalOrStartRunSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowManagerHost>::signal_or_start_run(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/gestalt.provider.v1.WorkflowManagerHost/CancelRun" => {
                    #[allow(non_camel_case_types)]
                    struct CancelRunSvc<T: WorkflowManagerHost>(pub Arc<T>);
                    impl<
                        T: WorkflowManagerHost,
                    > tonic::server::UnaryService<super::WorkflowManagerCancelRunRequest>
                    for CancelRunSvc<T> {
                        type Response = super::ManagedWorkflowRun;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                        ...
                        fn call(
                            &mut self,
                            request: tonic::Request<
                                super::WorkflowManagerCancelRunRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowManagerHost>::cancel_run(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/gestalt.provider.v1.WorkflowManagerHost/DeliverEvent" => {
                    #[allow(non_camel_case_types)]
                    struct DeliverEventSvc<T: WorkflowManagerHost>(pub Arc<T>);
                    impl<
                        T: WorkflowManagerHost,
                    > tonic::server::UnaryService<
                        super::WorkflowManagerDeliverEventRequest,
                    > for DeliverEventSvc<T> {
                        type Response = super::WorkflowManagerDeliverEventResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkflowManagerHost>::deliver_event(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
