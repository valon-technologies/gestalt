...
*/
        pub async fn open_database(
            ...
            request: impl tonic::IntoStreamingRequest<
                Message = super::OpenDatabaseClientMessage,
            >,
        ) -> std::result::Result<
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("gestalt.provider.v1.IndexedDB", "OpenDatabase"),
                );
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("gestalt.provider.v1.IndexedDB", "DeleteDatabase"),
                );
        ...
        pub async fn databases(
            ...
            tonic::Response<super::DatabasesResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("gestalt.provider.v1.IndexedDB", "Databases"));
            self.inner.unary(req, path, codec).await
        }
        ///
        pub async fn compare_keys(
            ...
            tonic::Response<super::CompareKeysResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("gestalt.provider.v1.IndexedDB", "CompareKeys"));
            self.inner.unary(req, path, codec).await
        }
    ...
    pub trait IndexedDb: std::marker::Send + std::marker::Sync + 'static {
        ...
        type OpenDatabaseStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<
                    super::OpenDatabaseServerMessage,
                    tonic::Status,
                >,
            >
            + std::marker::Send
...
*/
        ...
        async fn delete_database(
            ...
            tonic::Response<Self::DeleteDatabaseStream>,
            tonic::Status,
        >;
        ///
        async fn databases(
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/gestalt.provider.v1.IndexedDB/Databases" => {
                    ...
                    impl<
                        T: IndexedDb,
                    > tonic::server::UnaryService<super::DatabasesRequest>
                    for DatabasesSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as IndexedDb>::databases(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/gestalt.provider.v1.IndexedDB/CompareKeys" => {
                    ...
                    impl<
                        T: IndexedDb,
                    > tonic::server::UnaryService<super::CompareKeysRequest>
                    for CompareKeysSvc<T> {
