...
pub mod authorization_provider_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn set_relationships(
            &mut self,
            request: impl tonic::IntoRequest<super::SetRelationshipsRequest>,
        ) -> std::result::Result<tonic::Response<super::SetRelationshipsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/gestalt.provider.v1.AuthorizationProvider/SetRelationships",
            );
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "gestalt.provider.v1.AuthorizationProvider",
...
pub mod authorization_provider_server {
    ...
    pub trait AuthorizationProvider: std::marker::Send + std::marker::Sync + 'static {
        ...
        ///
        async fn set_relationships(
            &self,
            request: tonic::Request<super::SetRelationshipsRequest>,
        ) -> std::result::Result<tonic::Response<super::SetRelationshipsResponse>, tonic::Status>;
        ///
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/gestalt.provider.v1.AuthorizationProvider/SetRelationships" => {
                    #[allow(non_camel_case_types)]
                    struct SetRelationshipsSvc<T: AuthorizationProvider>(pub Arc<T>);
                    impl<T: AuthorizationProvider>
                        tonic::server::UnaryService<super::SetRelationshipsRequest>
                        for SetRelationshipsSvc<T>
                    {
                        type Response = super::SetRelationshipsResponse;
                        type Future = BoxFuture<tonic::Response<Self::Response>, tonic::Status>;
                        fn call(
                            &mut self,
                            request: tonic::Request<super::SetRelationshipsRequest>,
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AuthorizationProvider>::set_relationships(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = SetRelationshipsSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
...
pub mod runtime_log_host_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::AppendRuntimeLogsResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
