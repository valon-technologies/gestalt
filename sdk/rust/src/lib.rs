...
pub mod public;
/// Generated RemoteManagement client and native types.
pub mod remote;
...
pub use catalog::{
    ApiExposureMode, Catalog, CatalogOperation, CatalogParameter, OperationAnnotations,
    OperationResponseSpec, StreamResponseSpec, UnaryResponseSpec,
};
pub use env::{
