...
impl Cache {
    ...
    pub async fn get(&mut self, key: String) -> Result<Option<Vec<u8>>, GestaltError> {
        ...
        let response = from_wire_cache_get_response(
            self.inner
                .get(to_wire_cache_get_request(request))
                .await?
                .into_inner(),
        );
        if !response.found {
    ...
    pub async fn delete(&mut self, key: String) -> Result<bool, GestaltError> {
        ...
        let response = from_wire_cache_delete_response(
            self.inner
    ...
    pub async fn touch(
        ...
        let response = from_wire_cache_touch_response(
            self.inner
