...
func (UnimplementedProviderPluginServer) AuthorizationURL(context.Context, *AuthorizationURLRequest) (*AuthorizationURLResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AuthorizationURL not implemented")
}
...
func (UnimplementedProviderPluginServer) GetSessionCatalog(context.Context, *GetSessionCatalogRequest) (*GetSessionCatalogResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSessionCatalog not implemented")
}
func (UnimplementedProviderPluginServer) PostConnect(context.Context, *PostConnectRequest) (*PostConnectResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PostConnect not implemented")
}
...
var ProviderPlugin_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "sdk/pluginapi/v1/plugin.proto",
}
