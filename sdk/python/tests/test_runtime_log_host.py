...
class _RuntimeLogHostServicer(runtime_provider_pb2_grpc.RuntimeLogHostServicer):
    def AppendLogs(self, request: Any, context: grpc.ServicerContext) -> Any:
        ...
        return runtime_provider_pb2.AppendRuntimeLogsResponse(last_seq=last_seq)
...
def setUpModule() -> None:
    ...
    runtime_provider_pb2_grpc.add_RuntimeLogHostServicer_to_server(
...
class RuntimeLogHostTransportTests(unittest.TestCase):
    ...
    def test_runtime_log_host_append_writer_and_logging_handler(self) -> None:
        ...
        self.assertEqual(
            ...
            runtime_provider_pb2.RUNTIME_LOG_STREAM_RUNTIME,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            runtime_provider_pb2.RUNTIME_LOG_STREAM_STDERR,
        )
