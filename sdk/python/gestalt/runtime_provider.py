...
class Runtime:
    ...
    def get_support(self) -> RuntimeSupport:
        response = _support.call_unary(lambda: self._stub.GetSupport(_empty.Empty()))
        ...
        *,
        ...
        response = _support.call_unary(
            lambda: self._stub.StartApp(
                _codec.to_wire_start_hosted_app_request(request)
            )
        )
...
class RuntimeLogHost:
    ...
    @classmethod
    def connect(cls, name: str | None = None) -> RuntimeLogHost:
