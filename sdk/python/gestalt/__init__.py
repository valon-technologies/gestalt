...
_LAZY_EXPORTS = {
    ...
    "IndexedDBClient": ("._indexeddb", "IndexedDBClient"),
    "IndexedDBCursorClient": ("._indexeddb", "IndexedDBCursorClient"),
    "IndexedDBCursorSnapshot": ("._indexeddb", "IndexedDBCursorSnapshot"),
    "IndexedDBCursorSnapshotEntry": (
        "._indexeddb",
        "IndexedDBCursorSnapshotEntry",
    ),
    "IndexedDBIndexClient": ("._indexeddb", "IndexedDBIndexClient"),
    "IndexedDBObjectStoreClient": ("._indexeddb", "IndexedDBObjectStoreClient"),
    "IndexedDBOpenCursorRequest": ("._indexeddb", "IndexedDBOpenCursorRequest"),
    "IndexedDBTransactionClient": ("._indexeddb", "IndexedDBTransactionClient"),
    "IndexedDBTransactionIndexClient": (
        "._indexeddb",
        "IndexedDBTransactionIndexClient",
    ),
    "IndexedDBTransactionObjectStoreClient": (
        "._indexeddb",
        "IndexedDBTransactionObjectStoreClient",
    ),
    ...
    "S3ObjectHandle": ("._s3", "S3ObjectHandle"),
