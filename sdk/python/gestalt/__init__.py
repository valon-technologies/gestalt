...
_AGENT_HELPER_EXPORTS = (
    ...
    "AgentToolRefInput",
    "AgentWorkspaceGitCheckoutInput",
    "AgentWorkspaceInput",
...
_WORKFLOW_AUTHORED_EXPORTS = (
    ...
    "WorkflowManagerCreateEventTriggerInput",
    "WorkflowManagerCreateScheduleInput",
    "WorkflowManagerDeleteDefinitionInput",
    "WorkflowManagerDeleteEventTriggerInput",
    "WorkflowManagerDeleteScheduleInput",
    "WorkflowManagerGetDefinitionInput",
    "WorkflowManagerGetEventTriggerInput",
    "WorkflowManagerGetScheduleInput",
    "WorkflowManagerPauseEventTriggerInput",
    "WorkflowManagerPauseScheduleInput",
    "WorkflowManagerPublishEventInput",
    "WorkflowManagerResumeEventTriggerInput",
    "WorkflowManagerResumeScheduleInput",
    "WorkflowManagerSignalOrStartRunInput",
    "WorkflowManagerSignalRunInput",
    "WorkflowManagerStartRunInput",
    "WorkflowManagerUpdateDefinitionInput",
    "WorkflowManagerUpdateEventTriggerInput",
