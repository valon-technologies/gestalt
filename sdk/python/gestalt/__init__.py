...
_WORKFLOW_AUTHORED_EXPORTS = (
    ...
    "WORKFLOW_DEPLOYMENT_STATUS_DELETED",
    "WORKFLOW_DEPLOYMENT_STATUS_FAILED",
    "WORKFLOW_DEPLOYMENT_STATUS_PAUSED",
    "WORKFLOW_DEPLOYMENT_STATUS_PENDING",
    "WORKFLOW_DEPLOYMENT_STATUS_UNSPECIFIED",
    ...
    "set_workflow_deployment_paused_request",
    ...
    "workflow_array",
    "workflow_deployment",
    "workflow_deployment_binding",
    "workflow_deployment_spec",
    "workflow_event",
    ...
    "workflow_manager_apply_deployment_request",
    "workflow_manager_cancel_run_request",
    "workflow_manager_delete_deployment_request",
    "workflow_manager_deliver_event_request",
    "workflow_manager_deliver_event_response",
    "workflow_manager_get_deployment_request",
    "workflow_manager_list_deployments_request",
    "workflow_manager_list_deployments_response",
    "workflow_manager_plan_deployment_request",
    "workflow_manager_set_activation_paused_request",
    "workflow_manager_set_deployment_paused_request",
