...
class Authentication:
    ...
    def begin_login(
        ...
        *,
        ...
        response = _support.call_unary(
            lambda: self._stub.BeginLogin(_codec.to_wire_begin_login_request(request))
        )
        ...
        *,
        ...
        response = _support.call_unary(
            lambda: self._stub.CompleteLogin(
                _codec.to_wire_complete_login_request(request)
            )
        )
    ...
    def get_session_settings(self) -> AuthSessionSettings:
        response = _support.call_unary(
            lambda: self._stub.GetSessionSettings(_empty.Empty())
        )
