...
def add_ProviderLifecycleServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetPluginMetadata': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=v1_dot_runtime__pb2.PluginMetadata.SerializeToString,
            ),
            'ConfigurePlugin': grpc.unary_unary_rpc_method_handler(
                    servicer.ConfigurePlugin,
                    request_deserializer=v1_dot_runtime__pb2.ConfigurePluginRequest.FromString,
                    response_serializer=v1_dot_runtime__pb2.ConfigurePluginResponse.SerializeToString,
            ),
