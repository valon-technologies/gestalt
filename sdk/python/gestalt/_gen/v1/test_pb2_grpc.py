...
from . import test_pb2 as v1_dot_test__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in v1/test_pb2_grpc.py depends on'
...
def add_TestServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'HelloWorld': grpc.unary_unary_rpc_method_handler(
                    servicer.HelloWorld,
                    request_deserializer=v1_dot_test__pb2.HelloWorldRequest.FromString,
                    response_serializer=v1_dot_test__pb2.HelloWorldResponse.SerializeToString,
            ),
    }
