...
class ApplyWorkflowProviderDefinitionRequest(_message.Message):
    ...
    def __init__(self, provider: _Optional[str] = ..., spec: _Optional[_Union[WorkflowDefinitionSpec, _Mapping]] = ..., idempotency_key: _Optional[str] = ..., context: _Optional[_Union[_app_pb2.RequestContext, _Mapping]] = ...) -> None: ...
...
class GetWorkflowProviderDefinitionRequest(_message.Message):
    ...
    context: _app_pb2.RequestContext
    provider: str
    def __init__(self, definition_id: _Optional[str] = ..., context: _Optional[_Union[_app_pb2.RequestContext, _Mapping]] = ..., provider: _Optional[str] = ...) -> None: ...
...
class ListWorkflowProviderDefinitionsRequest(_message.Message):
    ...
    context: _app_pb2.RequestContext
    provider: str
    def __init__(self, context: _Optional[_Union[_app_pb2.RequestContext, _Mapping]] = ..., provider: _Optional[str] = ...) -> None: ...
...
class SetWorkflowProviderDefinitionPausedRequest(_message.Message):
    ...
    context: _app_pb2.RequestContext
    provider: str
    def __init__(self, definition_id: _Optional[str] = ..., paused: _Optional[bool] = ..., context: _Optional[_Union[_app_pb2.RequestContext, _Mapping]] = ..., provider: _Optional[str] = ...) -> None: ...
...
class SetWorkflowProviderActivationPausedRequest(_message.Message):
    ...
    context: _app_pb2.RequestContext
    provider: str
    def __init__(self, definition_id: _Optional[str] = ..., activation_id: _Optional[str] = ..., paused: _Optional[bool] = ..., context: _Optional[_Union[_app_pb2.RequestContext, _Mapping]] = ..., provider: _Optional[str] = ...) -> None: ...
...
class StartWorkflowProviderRunRequest(_message.Message):
    ...
    context: _app_pb2.RequestContext
    def __init__(self, idempotency_key: _Optional[str] = ..., workflow_key: _Optional[str] = ..., provider: _Optional[str] = ..., definition_id: _Optional[str] = ..., input: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., expected_definition_generation: _Optional[int] = ..., context: _Optional[_Union[_app_pb2.RequestContext, _Mapping]] = ...) -> None: ...
...
class GetWorkflowProviderRunRequest(_message.Message):
    ...
    context: _app_pb2.RequestContext
    provider: str
    def __init__(self, run_id: _Optional[str] = ..., context: _Optional[_Union[_app_pb2.RequestContext, _Mapping]] = ..., provider: _Optional[str] = ...) -> None: ...
...
class CancelWorkflowProviderRunRequest(_message.Message):
    ...
    context: _app_pb2.RequestContext
    provider: str
    def __init__(self, run_id: _Optional[str] = ..., reason: _Optional[str] = ..., context: _Optional[_Union[_app_pb2.RequestContext, _Mapping]] = ..., provider: _Optional[str] = ...) -> None: ...
...
class SignalWorkflowProviderRunRequest(_message.Message):
    ...
    context: _app_pb2.RequestContext
    provider: str
    def __init__(self, run_id: _Optional[str] = ..., signal: _Optional[_Union[WorkflowSignal, _Mapping]] = ..., context: _Optional[_Union[_app_pb2.RequestContext, _Mapping]] = ..., provider: _Optional[str] = ...) -> None: ...
...
class SignalOrStartWorkflowProviderRunRequest(_message.Message):
    ...
    expected_definition_generation: int
    context: _app_pb2.RequestContext
    def __init__(self, workflow_key: _Optional[str] = ..., idempotency_key: _Optional[str] = ..., signal: _Optional[_Union[WorkflowSignal, _Mapping]] = ..., provider: _Optional[str] = ..., definition_id: _Optional[str] = ..., input: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., expected_definition_generation: _Optional[int] = ..., context: _Optional[_Union[_app_pb2.RequestContext, _Mapping]] = ...) -> None: ...
...
class DeliverWorkflowProviderEventRequest(_message.Message):
    ...
    event: WorkflowEvent
    context: _app_pb2.RequestContext
    def __init__(self, provider: _Optional[str] = ..., event: _Optional[_Union[WorkflowEvent, _Mapping]] = ..., context: _Optional[_Union[_app_pb2.RequestContext, _Mapping]] = ...) -> None: ...
