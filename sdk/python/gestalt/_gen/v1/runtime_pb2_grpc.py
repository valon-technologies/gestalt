...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in v1/runtime_pb2_grpc.py depends on'
...
class ProviderLifecycleStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StartProvider = channel.unary_unary(
                ...
                _registered_method=True)
        self.PromoteWorkers = channel.unary_unary(
                '/gestalt.provider.v1.ProviderLifecycle/PromoteWorkers',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=v1_dot_runtime__pb2.PromoteWorkersResponse.FromString,
                _registered_method=True)
...
class ProviderLifecycleServicer(object):
    ...
    def PromoteWorkers(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_ProviderLifecycleServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'PromoteWorkers': grpc.unary_unary_rpc_method_handler(
                    servicer.PromoteWorkers,
                    request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                    response_serializer=v1_dot_runtime__pb2.PromoteWorkersResponse.SerializeToString,
            ),
    }
...
class ProviderLifecycle(object):
    ...
    def PromoteWorkers(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/gestalt.provider.v1.ProviderLifecycle/PromoteWorkers',
            google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            v1_dot_runtime__pb2.PromoteWorkersResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
