...
class WorkflowGRPC:
    """gRPC client for the public gestalt.provider.v1.Workflow surface."""
...
class WorkflowREST:
    """REST client for the public gestalt.provider.v1.Workflow surface."""
    ...
    def apply_definition(
        ...
        return _codec.from_wire_workflow_definition(wire)
    ...
    def list_definitions(
        ...
        response = _codec.from_wire_list_workflow_provider_definitions_response(wire)
        return response.definitions
    ...
    def start_run(self, request: StartWorkflowProviderRunRequest) -> WorkflowRun:
        ...
        return _codec.from_wire_workflow_run(wire)
    ...
    def list_runs(
        ...
        return _codec.from_wire_list_workflow_provider_runs_response(wire)
    ...
    def get_run_events(
        ...
        response = _codec.from_wire_get_workflow_provider_run_events_response(wire)
        return response.events
    ...
    def get_run_output(
        ...
        response = _codec.from_wire_get_workflow_provider_run_output_response(wire)
        return response.output
    ...
    def signal_run(
        ...
        return _codec.from_wire_signal_workflow_run_response(wire)
