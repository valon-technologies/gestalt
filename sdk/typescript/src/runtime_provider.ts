...
export class Runtime {
  ...
  async startSession(
    ...
    const response = await callUnary(() =>
      this.client.startSession(toWireStartRuntimeSessionRequest(request)),
    );
  ...
  async getSession(sessionId: string): Promise<RuntimeSession> {
    ...
    const response = await callUnary(() =>
      this.client.getSession(toWireGetRuntimeSessionRequest(request)),
    );
    return fromWireRuntimeSession(response);
  }
  ...
  async listSessions(
    ...
    const response = await callUnary(() =>
      this.client.listSessions(toWireListRuntimeSessionsRequest(request)),
    );
  ...
  async stopSession(sessionId: string): Promise<void> {
    ...
    await callUnary(() =>
      this.client.stopSession(toWireStopRuntimeSessionRequest(request)),
    );
  }
  ...
  async prepareWorkspace(
    ...
    const request: PrepareRuntimeWorkspaceRequest = {
      sessionId,
      agentSessionId,
  ...
  async removeWorkspace(
    ...
    const request: RemoveRuntimeWorkspaceRequest = {
      sessionId,
      agentSessionId,
    };
    await callUnary(() =>
      this.client.removeWorkspace(toWireRemoveRuntimeWorkspaceRequest(request)),
    );
  }
  ...
  async startApp(
    ...
    const request: StartHostedAppRequest = {
      sessionId,
      appName,
      command,
      args,
    ...
    const response = await callUnary(() =>
      this.client.startApp(toWireStartHostedAppRequest(request)),
    );
...
export class RuntimeLogHost {
  ...
  async appendLogs(
    ...
    const response = fromWireAppendRuntimeLogsResponse(
      await callUnary(() =>
        this.client.appendLogs(toWireAppendRuntimeLogsRequest(request)),
      ),
    );
