...
export class Agent {
  ...
  static connect(name?: string, options?: { context?: RequestContext }): Agent {
  ...
  async createSession(
    ...
    const request: CreateAgentProviderSessionRequest = {
      providerName,
      idempotencyKey,
      model,
      clientRef,
  ...
  async getSession(
    ...
    const request: GetAgentProviderSessionRequest = {
      sessionId,
      providerName,
      ...(this.context !== undefined ? { context: this.context } : {}),
    };
  ...
  async listSessions(
    ...
    const request: ListAgentProviderSessionsRequest = {
      sessionIds,
      state,
      limit,
      summaryOnly,
  ...
  async updateSession(
    ...
    const request: UpdateAgentProviderSessionRequest = {
      sessionId,
      clientRef,
      state,
      providerName,
  ...
  async createTurn(
    ...
    const request: CreateAgentProviderTurnRequest = {
      sessionId,
      idempotencyKey,
      model,
      executionRef,
  ...
  async getTurn(turnId: string, providerName: string): Promise<AgentTurn> {
    const request: GetAgentProviderTurnRequest = {
      turnId,
      providerName,
      ...(this.context !== undefined ? { context: this.context } : {}),
    };
  ...
  async listTurns(
    ...
    const request: ListAgentProviderTurnsRequest = {
      sessionId,
      turnIds,
      status,
      limit,
  ...
  async cancelTurn(
    ...
    const request: CancelAgentProviderTurnRequest = {
      turnId,
      reason,
      providerName,
      ...(this.context !== undefined ? { context: this.context } : {}),
  ...
  async listTurnEvents(
    ...
    const request: ListAgentProviderTurnEventsRequest = {
      turnId,
      afterSeq,
      limit,
      providerName,
  ...
  async getInteraction(interactionId: string): Promise<AgentInteraction> {
    const request: GetAgentProviderInteractionRequest = {
      interactionId,
      ...(this.context !== undefined ? { context: this.context } : {}),
    };
    const response = await callUnary(() =>
  ...
  async listInteractions(
    ...
    const request: ListAgentProviderInteractionsRequest = {
      turnId,
      providerName,
      ...(this.context !== undefined ? { context: this.context } : {}),
    };
  ...
  async resolveInteraction(
    ...
    const request: ResolveAgentProviderInteractionRequest = {
      interactionId,
      turnId,
      providerName,
