...
export class IndexedDB {
  ...
  async createObjectStore(
    ...
    const request: CreateObjectStoreRequest = {
      name,
      ...(schema !== undefined ? { schema } : {}),
    };
    await callUnary(() =>
      this.client.createObjectStore(toWireCreateObjectStoreRequest(request)),
    );
  }
  ...
  async deleteObjectStore(name: string): Promise<void> {
    ...
    await callUnary(() =>
      this.client.deleteObjectStore(toWireDeleteObjectStoreRequest(request)),
    );
  }
  ...
  async get(store: string, id: string): Promise<RecordResponse> {
    ...
    const response = await callUnary(() =>
      this.client.get(toWireObjectStoreRequest(request)),
    );
  ...
  async getKey(store: string, id: string): Promise<KeyResponse> {
    const request: ObjectStoreRequest = { store, id };
    const response = await callUnary(() =>
      this.client.getKey(toWireObjectStoreRequest(request)),
    );
  ...
  async delete(store: string, id: string): Promise<void> {
    const request: ObjectStoreRequest = { store, id };
    await callUnary(() =>
      this.client.delete(toWireObjectStoreRequest(request)),
    );
  }
  ...
  async clear(store: string): Promise<void> {
    ...
    await callUnary(() =>
      this.client.clear(toWireObjectStoreNameRequest(request)),
    );
  }
  ...
  async getAll(store: string, range?: KeyRange): Promise<RecordsResponse> {
    const request: ObjectStoreRangeRequest = {
      store,
      ...(range !== undefined ? { range } : {}),
    };
    const response = await callUnary(() =>
      this.client.getAll(toWireObjectStoreRangeRequest(request)),
    );
  ...
  async getAllKeys(store: string, range?: KeyRange): Promise<KeysResponse> {
    ...
    const response = await callUnary(() =>
      this.client.getAllKeys(toWireObjectStoreRangeRequest(request)),
    );
  ...
  async count(store: string, range?: KeyRange): Promise<CountResponse> {
    ...
    const response = await callUnary(() =>
      this.client.count(toWireObjectStoreRangeRequest(request)),
    );
  ...
  async deleteRange(store: string, range?: KeyRange): Promise<DeleteResponse> {
    ...
    const response = await callUnary(() =>
      this.client.deleteRange(toWireObjectStoreRangeRequest(request)),
    );
  ...
  async indexGet(
    ...
    const request: IndexQueryRequest = {
      store,
      index,
      values,
      ...(range !== undefined ? { range } : {}),
    ...
    const response = await callUnary(() =>
      this.client.indexGet(toWireIndexQueryRequest(request)),
    );
    return fromWireRecordResponse(response);
  }
  ...
  async indexGetKey(
    ...
    const response = await callUnary(() =>
      this.client.indexGetKey(toWireIndexQueryRequest(request)),
    );
    return fromWireKeyResponse(response);
  }
  ...
  async indexGetAll(
    ...
    const response = await callUnary(() =>
      this.client.indexGetAll(toWireIndexQueryRequest(request)),
    );
    return fromWireRecordsResponse(response);
  }
  ...
  async indexGetAllKeys(
    ...
    const response = await callUnary(() =>
      this.client.indexGetAllKeys(toWireIndexQueryRequest(request)),
    );
    return fromWireKeysResponse(response);
  }
  ...
  async indexCount(
    ...
    const response = await callUnary(() =>
      this.client.indexCount(toWireIndexQueryRequest(request)),
    );
    return fromWireCountResponse(response);
  }
  ...
  async indexDelete(
    ...
    const response = await callUnary(() =>
      this.client.indexDelete(toWireIndexQueryRequest(request)),
    );
    return fromWireDeleteResponse(response);
  }
   ...
   */
  openCursor(
    requests: AsyncIterable<CursorClientMessage>,
   ...
   */
  transaction(
    requests: AsyncIterable<TransactionClientMessage>,
