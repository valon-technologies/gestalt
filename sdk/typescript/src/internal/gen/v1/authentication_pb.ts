...
export const file_v1_authentication: GenFile = /*@__PURE__*/
  fileDesc("", [file_v1_annotations]);
...
export type TokenRequest = Message<"gestalt.provider.v1.TokenRequest"> & {
   ...
   * provider default. Non-standard; RFC 8693 leaves lifetime to server
   * discretion.
   *
   * @generated from field: int64 requested_ttl = 10;
   */
  requestedTtl: bigint;
};
...
export const UserInfoRequestSchema: GenMessage<UserInfoRequest> = /*@__PURE__*/
  messageDesc(file_v1_authentication, 13);
...
export const UserInfoResponseSchema: GenMessage<UserInfoResponse> = /*@__PURE__*/
  messageDesc(file_v1_authentication, 14);
...
export const Authentication: GenService<{
  ...
  /**
   * @generated from rpc gestalt.provider.v1.Authentication.UserInfo
   */
  userInfo: {
    methodKind: "unary";
