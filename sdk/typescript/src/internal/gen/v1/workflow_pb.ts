...
export type ListWorkflowProviderRunsRequest = Message<"gestalt.provider.v1.ListWorkflowProviderRunsRequest"> & {
  ...
  /**
   * @generated from field: string target_plugin = 3;
   */
  targetPlugin: string;
