...
export class App {
  ...
  async invoke<T = unknown>(
    ...
    const request: AppInvokeRequest = {
      app,
      operation,
      connection,
      instance,
  ...
  async invokeGraphQL(
    ...
    const request: AppInvokeGraphQLRequest = {
      app,
      document,
      connection,
      instance,
...
export class AppProvider {
  ...
  async startProvider(
    ...
    const request: StartProviderRequest = {
      name,
      protocolVersion,
      ...(config !== undefined ? { config } : {}),
    };
    const response = await callUnary(() =>
      this.client.startProvider(toWireStartProviderRequest(request)),
    );
  ...
  async getSessionCatalog(
    ...
    const request: GetSessionCatalogRequest = {
      token,
      invocationId,
      connectionParams: {},
      ...(this.context !== undefined ? { context: this.context } : {}),
