/**
 * Connect gRPC transport for the public Gestalt API (Node.js).
 */
...
/**
 * Creates a gRPC PublicTransport. Requires a Node.js runtime with
 * `@connectrpc/connect-node`.
 */
export function createGrpcTransport(
  options: GrpcTransportOptions,
): PublicTransport {
  const transport = createConnectGrpcTransport({
