...
export class S3 {
  ...
  async headObject(ref?: S3ObjectRef): Promise<HeadObjectResponse> {
    const request: HeadObjectRequest = { ...(ref !== undefined ? { ref } : {}) };
  ...
  async deleteObject(ref?: S3ObjectRef): Promise<void> {
    const request: DeleteObjectRequest = { ...(ref !== undefined ? { ref } : {}) };
  ...
  async listObjects(prefix: string, delimiter: string, continuationToken: string, startAfter: string, maxKeys: number): Promise<ListObjectsResponse> {
    const request: ListObjectsRequest = { prefix, delimiter, continuationToken, startAfter, maxKeys };
  ...
  async listObjectsRaw(request: ListObjectsRequest): Promise<ListObjectsResponse> {
    const response = await callUnary(() => this.client.listObjects(toWireListObjectsRequest(request)));
    return fromWireListObjectsResponse(response);
  }

  async copyObject(ifMatch: string, ifNoneMatch: string, source?: S3ObjectRef, destination?: S3ObjectRef): Promise<CopyObjectResponse> {
    const request: CopyObjectRequest = { ifMatch, ifNoneMatch, ...(source !== undefined ? { source } : {}), ...(destination !== undefined ? { destination } : {}) };
  ...
  async presignObject(method: PresignMethod, expiresSeconds: bigint, contentType: string, contentDisposition: string, ref?: S3ObjectRef): Promise<PresignObjectResponse> {
    const request: PresignObjectRequest = { method, expiresSeconds, contentType, contentDisposition, headers: {}, ...(ref !== undefined ? { ref } : {}) };
  ...
  async presignObjectRaw(request: PresignObjectRequest): Promise<PresignObjectResponse> {
    const response = await callUnary(() => this.client.presignObject(toWirePresignObjectRequest(request)));
    return fromWirePresignObjectResponse(response);
  }
...
export class S3ObjectAccess {
  ...
  async createObjectAccessURL(method: PresignMethod, expiresSeconds: bigint, contentType: string, contentDisposition: string, ref?: S3ObjectRef): Promise<CreateObjectAccessURLResponse> {
    const request: CreateObjectAccessURLRequest = { method, expiresSeconds, contentType, contentDisposition, headers: {}, ...(ref !== undefined ? { ref } : {}) };
  ...
  async createObjectAccessURLRaw(request: CreateObjectAccessURLRequest): Promise<CreateObjectAccessURLResponse> {
    const response = await callUnary(() => this.client.createObjectAccessURL(toWireCreateObjectAccessURLRequest(request)));
    return fromWireCreateObjectAccessURLResponse(response);
  }
