...
class ProviderHostStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ProxyHTTP = channel.unary_unary(
                '/gestalt.plugin.v1.ProviderHost/ProxyHTTP',
...
class ProviderHostServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_ProviderHostServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'gestalt.plugin.v1.ProviderHost', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('gestalt.plugin.v1.ProviderHost', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class ProviderHost(object):
    """Missing associated documentation comment in .proto file."""
