...
// tslint:disable
import { ProviderHost } from "./plugin";
import type { ProxyHTTPResponse } from "./plugin";
import type { ProxyHTTPRequest } from "./plugin";
...
/**
 * @generated from protobuf service gestalt.plugin.v1.ProviderHost
 */
export interface IProviderHostClient {
    /**
     * @generated from protobuf rpc: ProxyHTTP
     */
    proxyHTTP(input: ProxyHTTPRequest, options?: RpcOptions): UnaryCall<ProxyHTTPRequest, ProxyHTTPResponse>;
}
/**
 * @generated from protobuf service gestalt.plugin.v1.ProviderHost
 */
export class ProviderHostClient implements IProviderHostClient, ServiceInfo {
    typeName = ProviderHost.typeName;
    methods = ProviderHost.methods;
    options = ProviderHost.options;
    constructor(private readonly _transport: RpcTransport) {
    }
    /**
     * @generated from protobuf rpc: ProxyHTTP
    ...
    proxyHTTP(input: ProxyHTTPRequest, options?: RpcOptions): UnaryCall<ProxyHTTPRequest, ProxyHTTPResponse> {
        const method = this.methods[0], opt = this._transport.mergeOptions(options);
        return stackIntercept<ProxyHTTPRequest, ProxyHTTPResponse>("unary", this._transport, method, opt, input);
    }
}
