...
type hostBinding string

func firstBindingName(name ...string) string {
	if len(name) == 0 {
		return ""
	}
	return name[0]
...
func (b hostBinding) rpcCtx(parent context.Context) context.Context {
	return withHostServiceBinding(parent, string(b))
}
