...
func (c *App) Invoke(ctx context.Context, app string, operation string, connection string, instance string, idempotencyKey string, credentialMode string, params map[string]any) (*OperationResult, error) {
	request := &AppInvokeRequest{App: app, Operation: operation, Connection: connection, Instance: instance, IdempotencyKey: idempotencyKey, CredentialMode: credentialMode, Params: params, Context: c.context}
...
func (c *App) InvokeGraphQL(ctx context.Context, app string, document string, connection string, instance string, idempotencyKey string, variables map[string]any) (*OperationResult, error) {
	request := &AppInvokeGraphQLRequest{App: app, Document: document, Connection: connection, Instance: instance, IdempotencyKey: idempotencyKey, Variables: variables, Context: c.context}
