...
func (c *Agent) CreateSession(ctx context.Context, providerName string, idempotencyKey string, model string, opts *AgentCreateSessionOptions) (*AgentSession, error) {
	if opts == nil {
		opts = &AgentCreateSessionOptions{}
	}
	request := &CreateAgentProviderSessionRequest{ProviderName: providerName, IdempotencyKey: idempotencyKey, Model: model, ClientRef: opts.ClientRef, Metadata: opts.Metadata, Workspace: opts.Workspace, Tools: opts.Tools, Context: c.context}
