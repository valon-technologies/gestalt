...
func (c *S3) PresignObject(ctx context.Context, method PresignMethod, expiresSeconds int64, contentType string, contentDisposition string, ref *S3ObjectRef) (*PresignObjectResponse, error) {
	request := &PresignObjectRequest{Method: method, ExpiresSeconds: expiresSeconds, ContentType: contentType, ContentDisposition: contentDisposition, Ref: ref}
...
func (c *S3ObjectAccess) CreateObjectAccessURL(ctx context.Context, method PresignMethod, expiresSeconds int64, contentType string, contentDisposition string, ref *S3ObjectRef) (*CreateObjectAccessURLResponse, error) {
	request := &CreateObjectAccessURLRequest{Method: method, ExpiresSeconds: expiresSeconds, ContentType: contentType, ContentDisposition: contentDisposition, Ref: ref}
