...
var sharedExternalCredentialsTransport sharedManagerTransport[*client.ExternalCredentials]

// ExternalCredentials returns the generated client for the host-managed
// external credential service exposed by gestaltd, connected over the shared
...
func ExternalCredentials(ctx context.Context) (*client.ExternalCredentials, error) {
	...
	return managerTransportClient(ctx, "external credentials", target, token, &sharedExternalCredentialsTransport, client.NewExternalCredentials)
}
