...
func (db *IndexedDBClient) callCtx(ctx context.Context) context.Context {
	if db == nil {
		return ctx
	}
	return hostServiceCallCtx(ctx, db.binding)
}

// Close is a no-op because this client uses shared transport.
func (db *IndexedDBClient) Close() error { return nil }
...
func (db *IndexedDBClient) CreateObjectStore(ctx context.Context, name string, schema ObjectStoreSchema) error {
	...
	_, err := db.client.CreateObjectStore(db.callCtx(ctx), &proto.CreateObjectStoreRequest{
...
func (db *IndexedDBClient) DeleteObjectStore(ctx context.Context, name string) error {
	_, err := db.client.DeleteObjectStore(db.callCtx(ctx), &proto.DeleteObjectStoreRequest{Name: name})
	return grpcErr(err)
}
...
func (db *IndexedDBClient) Transaction(ctx context.Context, stores []string, mode TransactionMode, opts TransactionOptions) (*Transaction, error) {
	...
	streamCtx, cancel := context.WithCancel(db.callCtx(ctx))
...
func (o *ObjectStoreClient) callCtx(ctx context.Context) context.Context {
	return hostServiceCallCtx(ctx, o.binding)
}

// Get loads one record by primary key.
func (o *ObjectStoreClient) Get(ctx context.Context, id string) (Record, error) {
	resp, err := o.client.Get(o.callCtx(ctx), &proto.ObjectStoreRequest{Store: o.store, Id: id})
	if err != nil {
		return nil, grpcErr(err)
	}
...
func (o *ObjectStoreClient) GetKey(ctx context.Context, id string) (string, error) {
	resp, err := o.client.GetKey(o.callCtx(ctx), &proto.ObjectStoreRequest{Store: o.store, Id: id})
	if err != nil {
		return "", grpcErr(err)
	}
...
func (o *ObjectStoreClient) Add(ctx context.Context, record Record) error {
	...
	_, err = o.client.Add(o.callCtx(ctx), &proto.RecordRequest{Store: o.store, Record: pbRecord})
	return grpcErr(err)
}
...
func (o *ObjectStoreClient) Put(ctx context.Context, record Record) error {
	...
	_, err = o.client.Put(o.callCtx(ctx), &proto.RecordRequest{Store: o.store, Record: pbRecord})
	return grpcErr(err)
}

// Delete removes one record by primary key.
func (o *ObjectStoreClient) Delete(ctx context.Context, id string) error {
	_, err := o.client.Delete(o.callCtx(ctx), &proto.ObjectStoreRequest{Store: o.store, Id: id})
	return grpcErr(err)
}

// Clear removes every record from the object store.
func (o *ObjectStoreClient) Clear(ctx context.Context) error {
	_, err := o.client.Clear(o.callCtx(ctx), &proto.ObjectStoreNameRequest{Store: o.store})
	return grpcErr(err)
}
...
func (o *ObjectStoreClient) GetAll(ctx context.Context, r *KeyRange) ([]Record, error) {
	...
	resp, err := o.client.GetAll(o.callCtx(ctx), &proto.ObjectStoreRangeRequest{Store: o.store, Range: kr})
	if err != nil {
		return nil, grpcErr(err)
	}
...
func (o *ObjectStoreClient) GetAllKeys(ctx context.Context, r *KeyRange) ([]string, error) {
	...
	resp, err := o.client.GetAllKeys(o.callCtx(ctx), &proto.ObjectStoreRangeRequest{Store: o.store, Range: kr})
	if err != nil {
		return nil, grpcErr(err)
	}
...
func (o *ObjectStoreClient) Count(ctx context.Context, r *KeyRange) (int64, error) {
	...
	resp, err := o.client.Count(o.callCtx(ctx), &proto.ObjectStoreRangeRequest{Store: o.store, Range: kr})
	if err != nil {
...
func (o *ObjectStoreClient) DeleteRange(ctx context.Context, r KeyRange) (int64, error) {
	...
	resp, err := o.client.DeleteRange(o.callCtx(ctx), &proto.ObjectStoreRangeRequest{Store: o.store, Range: kr})
	if err != nil {
		return 0, grpcErr(err)
	}
...
func (o *ObjectStoreClient) OpenCursor(ctx context.Context, r *KeyRange, dir CursorDirection) (*Cursor, error) {
	return openCursor(o.callCtx(ctx), o.client, o.store, "", r, dir, false, nil)
}
...
func (o *ObjectStoreClient) OpenKeyCursor(ctx context.Context, r *KeyRange, dir CursorDirection) (*Cursor, error) {
	return openCursor(o.callCtx(ctx), o.client, o.store, "", r, dir, true, nil)
}
...
func (idx *IndexClient) callCtx(ctx context.Context) context.Context {
	return hostServiceCallCtx(ctx, idx.binding)
}
...
func (idx *IndexClient) Get(ctx context.Context, values ...any) (Record, error) {
	...
	resp, err := idx.client.IndexGet(idx.callCtx(ctx), &proto.IndexQueryRequest{
...
func (idx *IndexClient) GetKey(ctx context.Context, values ...any) (string, error) {
	...
	resp, err := idx.client.IndexGetKey(idx.callCtx(ctx), &proto.IndexQueryRequest{
		Store: idx.store, Index: idx.index, Values: vals,
	})
	if err != nil {
		return "", grpcErr(err)
...
func (idx *IndexClient) GetAll(ctx context.Context, r *KeyRange, values ...any) ([]Record, error) {
	...
	resp, err := idx.client.IndexGetAll(idx.callCtx(ctx), &proto.IndexQueryRequest{
...
func (idx *IndexClient) GetAllKeys(ctx context.Context, r *KeyRange, values ...any) ([]string, error) {
	...
	resp, err := idx.client.IndexGetAllKeys(idx.callCtx(ctx), &proto.IndexQueryRequest{
		Store: idx.store, Index: idx.index, Values: vals, Range: kr,
	})
	if err != nil {
		return nil, grpcErr(err)
...
func (idx *IndexClient) Count(ctx context.Context, r *KeyRange, values ...any) (int64, error) {
	...
	resp, err := idx.client.IndexCount(idx.callCtx(ctx), &proto.IndexQueryRequest{
		Store: idx.store, Index: idx.index, Values: vals, Range: kr,
	})
	if err != nil {
		return 0, grpcErr(err)
...
func (idx *IndexClient) DeleteRange(ctx context.Context, r *KeyRange, values ...any) (int64, error) {
	...
	resp, err := idx.client.IndexDelete(idx.callCtx(ctx), &proto.IndexQueryRequest{
		Store: idx.store, Index: idx.index, Values: vals, Range: kr,
	})
	if err != nil {
		return 0, grpcErr(err)
...
func (idx *IndexClient) OpenCursor(ctx context.Context, r *KeyRange, dir CursorDirection, values ...any) (*Cursor, error) {
	return openCursor(idx.callCtx(ctx), idx.client, idx.store, idx.index, r, dir, false, values)
}
...
func (idx *IndexClient) OpenKeyCursor(ctx context.Context, r *KeyRange, dir CursorDirection, values ...any) (*Cursor, error) {
	return openCursor(idx.callCtx(ctx), idx.client, idx.store, idx.index, r, dir, true, values)
}
