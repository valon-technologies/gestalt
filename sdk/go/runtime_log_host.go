...
// EnvRuntimeLogHostSocket is deprecated. Host-service clients now read
// [EnvHostServiceSocket].
const EnvRuntimeLogHostSocket = EnvHostServiceSocket

// EnvRuntimeLogHostSocketToken is deprecated. Host-service clients now read
// [EnvHostServiceToken].
const EnvRuntimeLogHostSocketToken = EnvHostServiceToken
