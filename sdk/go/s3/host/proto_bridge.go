...
// PresignMethodToProto encodes a presign HTTP method.
func PresignMethodToProto(method PresignMethod) proto.PresignMethod {
	return presignMethodToProto(method)
}

// PresignMethodFromProto decodes a presign HTTP method.
func PresignMethodFromProto(method proto.PresignMethod) PresignMethod {
	return presignMethodFromProto(method)
}

// ByteRangeFromProto decodes a byte range.
func ByteRangeFromProto(r *proto.ByteRange) *ByteRange {
	return byteRangeFromProto(r)
}
