...
const (
	...
	Workflow_UpsertSchedule_FullMethodName     = "/gestalt.provider.v1.Workflow/UpsertSchedule"
	Workflow_GetSchedule_FullMethodName        = "/gestalt.provider.v1.Workflow/GetSchedule"
	Workflow_ListSchedules_FullMethodName      = "/gestalt.provider.v1.Workflow/ListSchedules"
	Workflow_DeleteSchedule_FullMethodName     = "/gestalt.provider.v1.Workflow/DeleteSchedule"
	Workflow_PauseSchedule_FullMethodName      = "/gestalt.provider.v1.Workflow/PauseSchedule"
	Workflow_ResumeSchedule_FullMethodName     = "/gestalt.provider.v1.Workflow/ResumeSchedule"
	Workflow_UpsertEventTrigger_FullMethodName = "/gestalt.provider.v1.Workflow/UpsertEventTrigger"
	Workflow_GetEventTrigger_FullMethodName    = "/gestalt.provider.v1.Workflow/GetEventTrigger"
	Workflow_ListEventTriggers_FullMethodName  = "/gestalt.provider.v1.Workflow/ListEventTriggers"
	Workflow_DeleteEventTrigger_FullMethodName = "/gestalt.provider.v1.Workflow/DeleteEventTrigger"
	Workflow_PauseEventTrigger_FullMethodName  = "/gestalt.provider.v1.Workflow/PauseEventTrigger"
	Workflow_ResumeEventTrigger_FullMethodName = "/gestalt.provider.v1.Workflow/ResumeEventTrigger"
	Workflow_PublishEvent_FullMethodName       = "/gestalt.provider.v1.Workflow/PublishEvent"
)
...
type WorkflowClient interface {
	StartRun(ctx context.Context, in *StartWorkflowRunRequest, opts ...grpc.CallOption) (*WorkflowRun, error)
	GetRun(ctx context.Context, in *GetWorkflowRunRequest, opts ...grpc.CallOption) (*WorkflowRun, error)
	ListRuns(ctx context.Context, in *ListWorkflowRunsRequest, opts ...grpc.CallOption) (*ListWorkflowRunsResponse, error)
	CancelRun(ctx context.Context, in *CancelWorkflowRunRequest, opts ...grpc.CallOption) (*WorkflowRun, error)
	UpsertSchedule(ctx context.Context, in *UpsertWorkflowScheduleRequest, opts ...grpc.CallOption) (*WorkflowSchedule, error)
	GetSchedule(ctx context.Context, in *GetWorkflowScheduleRequest, opts ...grpc.CallOption) (*WorkflowSchedule, error)
	ListSchedules(ctx context.Context, in *ListWorkflowSchedulesRequest, opts ...grpc.CallOption) (*ListWorkflowSchedulesResponse, error)
	DeleteSchedule(ctx context.Context, in *DeleteWorkflowScheduleRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	PauseSchedule(ctx context.Context, in *PauseWorkflowScheduleRequest, opts ...grpc.CallOption) (*WorkflowSchedule, error)
	ResumeSchedule(ctx context.Context, in *ResumeWorkflowScheduleRequest, opts ...grpc.CallOption) (*WorkflowSchedule, error)
	UpsertEventTrigger(ctx context.Context, in *UpsertWorkflowEventTriggerRequest, opts ...grpc.CallOption) (*WorkflowEventTrigger, error)
	GetEventTrigger(ctx context.Context, in *GetWorkflowEventTriggerRequest, opts ...grpc.CallOption) (*WorkflowEventTrigger, error)
	ListEventTriggers(ctx context.Context, in *ListWorkflowEventTriggersRequest, opts ...grpc.CallOption) (*ListWorkflowEventTriggersResponse, error)
	DeleteEventTrigger(ctx context.Context, in *DeleteWorkflowEventTriggerRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
	PauseEventTrigger(ctx context.Context, in *PauseWorkflowEventTriggerRequest, opts ...grpc.CallOption) (*WorkflowEventTrigger, error)
	ResumeEventTrigger(ctx context.Context, in *ResumeWorkflowEventTriggerRequest, opts ...grpc.CallOption) (*WorkflowEventTrigger, error)
	PublishEvent(ctx context.Context, in *PublishWorkflowEventRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *workflowClient) StartRun(ctx context.Context, in *StartWorkflowRunRequest, opts ...grpc.CallOption) (*WorkflowRun, error) {
...
func (c *workflowClient) GetRun(ctx context.Context, in *GetWorkflowRunRequest, opts ...grpc.CallOption) (*WorkflowRun, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(WorkflowRun)
...
func (c *workflowClient) ListRuns(ctx context.Context, in *ListWorkflowRunsRequest, opts ...grpc.CallOption) (*ListWorkflowRunsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *workflowClient) CancelRun(ctx context.Context, in *CancelWorkflowRunRequest, opts ...grpc.CallOption) (*WorkflowRun, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(WorkflowRun)
...
func (c *workflowClient) UpsertSchedule(ctx context.Context, in *UpsertWorkflowScheduleRequest, opts ...grpc.CallOption) (*WorkflowSchedule, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(WorkflowSchedule)
	err := c.cc.Invoke(ctx, Workflow_UpsertSchedule_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *workflowClient) GetSchedule(ctx context.Context, in *GetWorkflowScheduleRequest, opts ...grpc.CallOption) (*WorkflowSchedule, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(WorkflowSchedule)
	err := c.cc.Invoke(ctx, Workflow_GetSchedule_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *workflowClient) ListSchedules(ctx context.Context, in *ListWorkflowSchedulesRequest, opts ...grpc.CallOption) (*ListWorkflowSchedulesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListWorkflowSchedulesResponse)
	err := c.cc.Invoke(ctx, Workflow_ListSchedules_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *workflowClient) DeleteSchedule(ctx context.Context, in *DeleteWorkflowScheduleRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Workflow_DeleteSchedule_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *workflowClient) PauseSchedule(ctx context.Context, in *PauseWorkflowScheduleRequest, opts ...grpc.CallOption) (*WorkflowSchedule, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(WorkflowSchedule)
	err := c.cc.Invoke(ctx, Workflow_PauseSchedule_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *workflowClient) ResumeSchedule(ctx context.Context, in *ResumeWorkflowScheduleRequest, opts ...grpc.CallOption) (*WorkflowSchedule, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(WorkflowSchedule)
	err := c.cc.Invoke(ctx, Workflow_ResumeSchedule_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *workflowClient) UpsertEventTrigger(ctx context.Context, in *UpsertWorkflowEventTriggerRequest, opts ...grpc.CallOption) (*WorkflowEventTrigger, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(WorkflowEventTrigger)
	err := c.cc.Invoke(ctx, Workflow_UpsertEventTrigger_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *workflowClient) GetEventTrigger(ctx context.Context, in *GetWorkflowEventTriggerRequest, opts ...grpc.CallOption) (*WorkflowEventTrigger, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(WorkflowEventTrigger)
	err := c.cc.Invoke(ctx, Workflow_GetEventTrigger_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *workflowClient) ListEventTriggers(ctx context.Context, in *ListWorkflowEventTriggersRequest, opts ...grpc.CallOption) (*ListWorkflowEventTriggersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListWorkflowEventTriggersResponse)
	err := c.cc.Invoke(ctx, Workflow_ListEventTriggers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *workflowClient) DeleteEventTrigger(ctx context.Context, in *DeleteWorkflowEventTriggerRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Workflow_DeleteEventTrigger_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *workflowClient) PauseEventTrigger(ctx context.Context, in *PauseWorkflowEventTriggerRequest, opts ...grpc.CallOption) (*WorkflowEventTrigger, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(WorkflowEventTrigger)
	err := c.cc.Invoke(ctx, Workflow_PauseEventTrigger_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *workflowClient) ResumeEventTrigger(ctx context.Context, in *ResumeWorkflowEventTriggerRequest, opts ...grpc.CallOption) (*WorkflowEventTrigger, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(WorkflowEventTrigger)
	err := c.cc.Invoke(ctx, Workflow_ResumeEventTrigger_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *workflowClient) PublishEvent(ctx context.Context, in *PublishWorkflowEventRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Workflow_PublishEvent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WorkflowServer interface {
	StartRun(context.Context, *StartWorkflowRunRequest) (*WorkflowRun, error)
	GetRun(context.Context, *GetWorkflowRunRequest) (*WorkflowRun, error)
	ListRuns(context.Context, *ListWorkflowRunsRequest) (*ListWorkflowRunsResponse, error)
	CancelRun(context.Context, *CancelWorkflowRunRequest) (*WorkflowRun, error)
	UpsertSchedule(context.Context, *UpsertWorkflowScheduleRequest) (*WorkflowSchedule, error)
	GetSchedule(context.Context, *GetWorkflowScheduleRequest) (*WorkflowSchedule, error)
	ListSchedules(context.Context, *ListWorkflowSchedulesRequest) (*ListWorkflowSchedulesResponse, error)
	DeleteSchedule(context.Context, *DeleteWorkflowScheduleRequest) (*emptypb.Empty, error)
	PauseSchedule(context.Context, *PauseWorkflowScheduleRequest) (*WorkflowSchedule, error)
	ResumeSchedule(context.Context, *ResumeWorkflowScheduleRequest) (*WorkflowSchedule, error)
	UpsertEventTrigger(context.Context, *UpsertWorkflowEventTriggerRequest) (*WorkflowEventTrigger, error)
	GetEventTrigger(context.Context, *GetWorkflowEventTriggerRequest) (*WorkflowEventTrigger, error)
	ListEventTriggers(context.Context, *ListWorkflowEventTriggersRequest) (*ListWorkflowEventTriggersResponse, error)
	DeleteEventTrigger(context.Context, *DeleteWorkflowEventTriggerRequest) (*emptypb.Empty, error)
	PauseEventTrigger(context.Context, *PauseWorkflowEventTriggerRequest) (*WorkflowEventTrigger, error)
	ResumeEventTrigger(context.Context, *ResumeWorkflowEventTriggerRequest) (*WorkflowEventTrigger, error)
	PublishEvent(context.Context, *PublishWorkflowEventRequest) (*emptypb.Empty, error)
...
func (UnimplementedWorkflowServer) StartRun(context.Context, *StartWorkflowRunRequest) (*WorkflowRun, error) {
	return nil, status.Error(codes.Unimplemented, "method StartRun not implemented")
}
func (UnimplementedWorkflowServer) GetRun(context.Context, *GetWorkflowRunRequest) (*WorkflowRun, error) {
	return nil, status.Error(codes.Unimplemented, "method GetRun not implemented")
}
func (UnimplementedWorkflowServer) ListRuns(context.Context, *ListWorkflowRunsRequest) (*ListWorkflowRunsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListRuns not implemented")
}
func (UnimplementedWorkflowServer) CancelRun(context.Context, *CancelWorkflowRunRequest) (*WorkflowRun, error) {
	return nil, status.Error(codes.Unimplemented, "method CancelRun not implemented")
}
func (UnimplementedWorkflowServer) UpsertSchedule(context.Context, *UpsertWorkflowScheduleRequest) (*WorkflowSchedule, error) {
	return nil, status.Error(codes.Unimplemented, "method UpsertSchedule not implemented")
}
func (UnimplementedWorkflowServer) GetSchedule(context.Context, *GetWorkflowScheduleRequest) (*WorkflowSchedule, error) {
	return nil, status.Error(codes.Unimplemented, "method GetSchedule not implemented")
}
func (UnimplementedWorkflowServer) ListSchedules(context.Context, *ListWorkflowSchedulesRequest) (*ListWorkflowSchedulesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListSchedules not implemented")
}
func (UnimplementedWorkflowServer) DeleteSchedule(context.Context, *DeleteWorkflowScheduleRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteSchedule not implemented")
}
func (UnimplementedWorkflowServer) PauseSchedule(context.Context, *PauseWorkflowScheduleRequest) (*WorkflowSchedule, error) {
	return nil, status.Error(codes.Unimplemented, "method PauseSchedule not implemented")
}
func (UnimplementedWorkflowServer) ResumeSchedule(context.Context, *ResumeWorkflowScheduleRequest) (*WorkflowSchedule, error) {
	return nil, status.Error(codes.Unimplemented, "method ResumeSchedule not implemented")
}
func (UnimplementedWorkflowServer) UpsertEventTrigger(context.Context, *UpsertWorkflowEventTriggerRequest) (*WorkflowEventTrigger, error) {
	return nil, status.Error(codes.Unimplemented, "method UpsertEventTrigger not implemented")
}
func (UnimplementedWorkflowServer) GetEventTrigger(context.Context, *GetWorkflowEventTriggerRequest) (*WorkflowEventTrigger, error) {
	return nil, status.Error(codes.Unimplemented, "method GetEventTrigger not implemented")
}
func (UnimplementedWorkflowServer) ListEventTriggers(context.Context, *ListWorkflowEventTriggersRequest) (*ListWorkflowEventTriggersResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListEventTriggers not implemented")
}
func (UnimplementedWorkflowServer) DeleteEventTrigger(context.Context, *DeleteWorkflowEventTriggerRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteEventTrigger not implemented")
}
func (UnimplementedWorkflowServer) PauseEventTrigger(context.Context, *PauseWorkflowEventTriggerRequest) (*WorkflowEventTrigger, error) {
	return nil, status.Error(codes.Unimplemented, "method PauseEventTrigger not implemented")
}
func (UnimplementedWorkflowServer) ResumeEventTrigger(context.Context, *ResumeWorkflowEventTriggerRequest) (*WorkflowEventTrigger, error) {
	return nil, status.Error(codes.Unimplemented, "method ResumeEventTrigger not implemented")
}
func (UnimplementedWorkflowServer) PublishEvent(context.Context, *PublishWorkflowEventRequest) (*emptypb.Empty, error) {
...
func _Workflow_StartRun_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkflowServer).StartRun(ctx, req.(*StartWorkflowRunRequest))
	}
...
func _Workflow_GetRun_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkflowServer).GetRun(ctx, req.(*GetWorkflowRunRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Workflow_ListRuns_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkflowServer).ListRuns(ctx, req.(*ListWorkflowRunsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Workflow_CancelRun_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkflowServer).CancelRun(ctx, req.(*CancelWorkflowRunRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Workflow_UpsertSchedule_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpsertWorkflowScheduleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Workflow_UpsertSchedule_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkflowServer).UpsertSchedule(ctx, req.(*UpsertWorkflowScheduleRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Workflow_GetSchedule_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Workflow_GetSchedule_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkflowServer).GetSchedule(ctx, req.(*GetWorkflowScheduleRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Workflow_ListSchedules_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListWorkflowSchedulesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WorkflowServer).ListSchedules(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Workflow_ListSchedules_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkflowServer).ListSchedules(ctx, req.(*ListWorkflowSchedulesRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Workflow_DeleteSchedule_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteWorkflowScheduleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WorkflowServer).DeleteSchedule(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Workflow_DeleteSchedule_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkflowServer).DeleteSchedule(ctx, req.(*DeleteWorkflowScheduleRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Workflow_PauseSchedule_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PauseWorkflowScheduleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WorkflowServer).PauseSchedule(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Workflow_PauseSchedule_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkflowServer).PauseSchedule(ctx, req.(*PauseWorkflowScheduleRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Workflow_ResumeSchedule_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ResumeWorkflowScheduleRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WorkflowServer).ResumeSchedule(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Workflow_ResumeSchedule_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkflowServer).ResumeSchedule(ctx, req.(*ResumeWorkflowScheduleRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Workflow_UpsertEventTrigger_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpsertWorkflowEventTriggerRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WorkflowServer).UpsertEventTrigger(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Workflow_UpsertEventTrigger_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkflowServer).UpsertEventTrigger(ctx, req.(*UpsertWorkflowEventTriggerRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Workflow_GetEventTrigger_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetWorkflowEventTriggerRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WorkflowServer).GetEventTrigger(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Workflow_GetEventTrigger_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkflowServer).GetEventTrigger(ctx, req.(*GetWorkflowEventTriggerRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Workflow_ListEventTriggers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListWorkflowEventTriggersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WorkflowServer).ListEventTriggers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Workflow_ListEventTriggers_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkflowServer).ListEventTriggers(ctx, req.(*ListWorkflowEventTriggersRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Workflow_DeleteEventTrigger_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteWorkflowEventTriggerRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WorkflowServer).DeleteEventTrigger(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Workflow_DeleteEventTrigger_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkflowServer).DeleteEventTrigger(ctx, req.(*DeleteWorkflowEventTriggerRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Workflow_PauseEventTrigger_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PauseWorkflowEventTriggerRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WorkflowServer).PauseEventTrigger(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Workflow_PauseEventTrigger_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkflowServer).PauseEventTrigger(ctx, req.(*PauseWorkflowEventTriggerRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Workflow_ResumeEventTrigger_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ResumeWorkflowEventTriggerRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WorkflowServer).ResumeEventTrigger(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Workflow_ResumeEventTrigger_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkflowServer).ResumeEventTrigger(ctx, req.(*ResumeWorkflowEventTriggerRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Workflow_PublishEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PublishWorkflowEventRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(WorkflowServer).PublishEvent(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Workflow_PublishEvent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WorkflowServer).PublishEvent(ctx, req.(*PublishWorkflowEventRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Workflow_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Workflow_ListSchedules_Handler,
		},
		{
			MethodName: "DeleteSchedule",
			Handler:    _Workflow_DeleteSchedule_Handler,
		},
		{
			MethodName: "PauseSchedule",
			Handler:    _Workflow_PauseSchedule_Handler,
		},
		{
			MethodName: "ResumeSchedule",
			Handler:    _Workflow_ResumeSchedule_Handler,
		},
		{
			MethodName: "UpsertEventTrigger",
			Handler:    _Workflow_UpsertEventTrigger_Handler,
		},
		{
			MethodName: "GetEventTrigger",
			Handler:    _Workflow_GetEventTrigger_Handler,
		},
		{
			MethodName: "ListEventTriggers",
			Handler:    _Workflow_ListEventTriggers_Handler,
		},
		{
			MethodName: "DeleteEventTrigger",
			Handler:    _Workflow_DeleteEventTrigger_Handler,
		},
		{
			MethodName: "PauseEventTrigger",
			Handler:    _Workflow_PauseEventTrigger_Handler,
		},
		{
			MethodName: "ResumeEventTrigger",
			Handler:    _Workflow_ResumeEventTrigger_Handler,
		},
		{
			MethodName: "PublishEvent",
			Handler:    _Workflow_PublishEvent_Handler,
		},
	},
