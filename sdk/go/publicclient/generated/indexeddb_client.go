...
// IndexedDBClient is the transport-neutral client for the public gestalt.provider.v1.IndexedDB surface.
...
func (c *IndexedDBClient) Add(ctx context.Context, request *RecordRequest) error {
	...
	if err := c.transport.Unary(ctx, MethodIndexedDBAdd, wire, &emptypb.Empty{}); err != nil {
...
func (c *IndexedDBClient) Clear(ctx context.Context, request *ObjectStoreNameRequest) error {
	...
	if err := c.transport.Unary(ctx, MethodIndexedDBClear, wire, &emptypb.Empty{}); err != nil {
		return toGestaltError(err)
	}
	return nil
}

func (c *IndexedDBClient) Count(ctx context.Context, request *ObjectStoreRangeRequest) (int64, error) {
...
func (c *IndexedDBClient) CreateIndex(ctx context.Context, request *CreateIndexRequest) error {
	...
	if err := c.transport.Unary(ctx, MethodIndexedDBCreateIndex, wire, &emptypb.Empty{}); err != nil {
		return toGestaltError(err)
	}
	return nil
}
...
func (c *IndexedDBClient) CreateObjectStore(ctx context.Context, request *CreateObjectStoreRequest) error {
	...
	if err := c.transport.Unary(ctx, MethodIndexedDBCreateObjectStore, wire, &emptypb.Empty{}); err != nil {
		return toGestaltError(err)
	}
	return nil
}
...
func (c *IndexedDBClient) Delete(ctx context.Context, request *ObjectStoreRequest) error {
	...
	if err := c.transport.Unary(ctx, MethodIndexedDBDelete, wire, &emptypb.Empty{}); err != nil {
		return toGestaltError(err)
	}
	return nil
}
...
func (c *IndexedDBClient) DeleteIndex(ctx context.Context, request *DeleteIndexRequest) error {
	...
	if err := c.transport.Unary(ctx, MethodIndexedDBDeleteIndex, wire, &emptypb.Empty{}); err != nil {
		return toGestaltError(err)
	}
	return nil
}
...
func (c *IndexedDBClient) DeleteObjectStore(ctx context.Context, request *DeleteObjectStoreRequest) error {
	...
	if err := c.transport.Unary(ctx, MethodIndexedDBDeleteObjectStore, wire, &emptypb.Empty{}); err != nil {
		return toGestaltError(err)
	}
	return nil
}
...
func (c *IndexedDBClient) IndexCount(ctx context.Context, request *IndexQueryRequest) (int64, error) {
...
func (c *IndexedDBClient) Put(ctx context.Context, request *RecordRequest) error {
	wire := ToWireRecordRequest(request)
	if err := c.transport.Unary(ctx, MethodIndexedDBPut, wire, &emptypb.Empty{}); err != nil {
		return toGestaltError(err)
	}
	return nil
}
