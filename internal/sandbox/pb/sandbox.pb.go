...
func (x *ToolResponse) GetStatus() int32 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *ToolDefinition) GetDestructive() bool {
	if x != nil {
...
const file_sandbox_v1_sandbox_proto_rawDesc = "" +
	...
	"\x05tools\x18\x01 \x03(\v2\".gestalt.sandbox.v1.ToolDefinitionR\x05tools\"\xeb\x01\n" +
	"\x0eToolDefinition\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1a\n" +
	"\bprovider\x18\x02 \x01(\tR\bprovider\x12\x1c\n" +
	"\toperation\x18\x03 \x01(\tR\toperation\x12 \n" +
	"\vdescription\x18\x04 \x01(\tR\vdescription\x12*\n" +
	"\x11input_schema_json\x18\x05 \x01(\tR\x0finputSchemaJson\x12\x1b\n" +
	"\tread_only\x18\x06 \x01(\bR\breadOnly\x12 \n" +
	"\vdestructive\x18\a \x01(\bR\vdestructive\"\x0f\n" +
	"\rHealthRequest\">\n" +
	...
	"\tListTools\x12$.gestalt.sandbox.v1.ListToolsRequest\x1a%.gestalt.sandbox.v1.ListToolsResponseB;Z9github.com/valon-technologies/gestalt/internal/sandbox/pbb\x06proto3"
...
var file_sandbox_v1_sandbox_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_sandbox_v1_sandbox_proto_goTypes = []any{
	...
	(*HealthRequest)(nil),       // 14: gestalt.sandbox.v1.HealthRequest
	(*HealthResponse)(nil),      // 15: gestalt.sandbox.v1.HealthResponse
	(*ShutdownRequest)(nil),     // 16: gestalt.sandbox.v1.ShutdownRequest
	(*ShutdownResponse)(nil),    // 17: gestalt.sandbox.v1.ShutdownResponse
}
var file_sandbox_v1_sandbox_proto_depIdxs = []int32{
	...
	0,  // 8: gestalt.sandbox.v1.SandboxService.Converse:input_type -> gestalt.sandbox.v1.ConversationRequest
	14, // 9: gestalt.sandbox.v1.SandboxService.Health:input_type -> gestalt.sandbox.v1.HealthRequest
	16, // 10: gestalt.sandbox.v1.SandboxService.Shutdown:input_type -> gestalt.sandbox.v1.ShutdownRequest
	9,  // 11: gestalt.sandbox.v1.ToolService.ExecuteTool:input_type -> gestalt.sandbox.v1.ToolRequest
	11, // 12: gestalt.sandbox.v1.ToolService.ListTools:input_type -> gestalt.sandbox.v1.ListToolsRequest
	2,  // 13: gestalt.sandbox.v1.SandboxService.Converse:output_type -> gestalt.sandbox.v1.ConversationEvent
	15, // 14: gestalt.sandbox.v1.SandboxService.Health:output_type -> gestalt.sandbox.v1.HealthResponse
	17, // 15: gestalt.sandbox.v1.SandboxService.Shutdown:output_type -> gestalt.sandbox.v1.ShutdownResponse
	10, // 16: gestalt.sandbox.v1.ToolService.ExecuteTool:output_type -> gestalt.sandbox.v1.ToolResponse
	12, // 17: gestalt.sandbox.v1.ToolService.ListTools:output_type -> gestalt.sandbox.v1.ListToolsResponse
