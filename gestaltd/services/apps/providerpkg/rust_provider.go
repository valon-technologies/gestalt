...
func BuildRustProviderTempBinary(root, pluginName, goos, goarch string) (string, func(), error) {
	return buildRustTempBinary(root, pluginName, providermanifestv1.KindApp, goos, goarch)
}
...
func BuildRustComponentTempBinary(root, kind, goos, goarch string) (string, func(), error) {
	...
	return buildRustTempBinary(root, sourceAppName(root), kind, goos, goarch)
}
...
func rustServeFunction(kind string) (string, bool, error) {
	...
	case providermanifestv1.KindIdentity:
		return "__gestalt_serve_identity", false, nil
...
func rustBinaryName(kind string) string {
	kind = providermanifestv1.NormalizeKind(kind)
	switch kind {
	case providermanifestv1.KindIdentity, providermanifestv1.KindCache, providermanifestv1.KindIndexedDB, providermanifestv1.KindS3, providermanifestv1.KindRuntime, providermanifestv1.KindWorkflow, providermanifestv1.KindAgent, providermanifestv1.KindSecrets:
		return kind
	default:
		return "provider"
	}
