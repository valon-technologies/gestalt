...
func TestNewServer_RESTCatalogToolsUseOperationConnections(t *testing.T) {
	...
	merged, err := composite.NewMergedWithConnections(
		...
		"Hybrid provider",
		"",
		composite.BoundProvider{Provider: pluginProv, Connection: core.AppConnectionName},
	...
	_ = ds.ExternalCredentials.PutCredential(ctx, &core.ExternalCredential{
		ID: "tok-plugin", SubjectID: principal.UserSubjectID(userID), Integration: "hybrid", Connection: core.AppConnectionName, Instance: "default",
