...
//go:generate go run ../../tools/routinggen -grpc ../../../../sdk/go/protov1/v1/cache_grpc.pb.go -service CacheServer -receiver routingCacheServer -binding cache -package cache -server-type proto.CacheServer -output routing_cache_gen.go
