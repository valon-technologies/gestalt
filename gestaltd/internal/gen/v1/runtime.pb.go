...
const (
	...
	ProviderKind_PROVIDER_KIND_MODEL               ProviderKind = 13
)
...
func (x *StartRuntimeProviderResponse) Reset() {
	*x = StartRuntimeProviderResponse{}
	mi := &file_v1_runtime_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *StartRuntimeProviderResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StartRuntimeProviderResponse) ProtoMessage() {}

func (x *StartRuntimeProviderResponse) ProtoReflect() protoreflect.Message {
	mi := &file_v1_runtime_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StartRuntimeProviderResponse.ProtoReflect.Descriptor instead.
func (*StartRuntimeProviderResponse) Descriptor() ([]byte, []int) {
...
const file_v1_runtime_proto_rawDesc = "" +
	...
	"!PROVIDER_KIND_EXTERNAL_CREDENTIAL\x10\f\x12\x17\n" +
	...
	"\rStartProvider\x12\x16.google.protobuf.Empty\x1a1.gestalt.provider.v1.StartRuntimeProviderResponseB\xd9\x01\n" +
	"\x17com.gestalt.provider.v1B\fRuntimeProtoP\x01ZBgithub.com/valon-technologies/gestalt/server/internal/gen/v1;proto\xa2\x02\x03GPX\xaa\x02\x13Gestalt.Provider.V1\xca\x02\x13Gestalt\\Provider\\V1\xe2\x02\x1fGestalt\\Provider\\V1\\GPBMetadata\xea\x02\x15Gestalt::Provider::V1b\x06proto3"
