...
func TestRegistryDiscoversPublicMethods(t *testing.T) {
	...
	want := []string{
		...
		gestaltproto.Workflow_ListDefinitions_FullMethodName,
		gestaltproto.Workflow_SetDefinitionPaused_FullMethodName,
		gestaltproto.Workflow_SetActivationPaused_FullMethodName,
		gestaltproto.Workflow_DeleteDefinition_FullMethodName,
		gestaltproto.Workflow_StartRun_FullMethodName,
		gestaltproto.Workflow_ListRuns_FullMethodName,
		gestaltproto.Workflow_GetRun_FullMethodName,
		gestaltproto.Workflow_GetRunEvents_FullMethodName,
		gestaltproto.Workflow_GetRunOutput_FullMethodName,
		gestaltproto.Workflow_CancelRun_FullMethodName,
		gestaltproto.Workflow_SignalRun_FullMethodName,
		gestaltproto.Workflow_SignalOrStartRun_FullMethodName,
