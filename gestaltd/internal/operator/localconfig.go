...
plugins:
  httpbin:
    ...
    allowedHosts:
      - httpbin.org
`, encryptionKey, config.DefaultIndexedDBProvider, config.DefaultIndexedDBVersion, "sqlite://"+dbPath, config.DefaultUIProvider, config.DefaultUIVersion, defaultHTTPBinProvider, defaultHTTPBinVersion)
}
