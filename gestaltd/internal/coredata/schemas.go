...
var IntegrationTokensSchema = indexeddb.ObjectStoreSchema{
	Indexes: []indexeddb.IndexSchema{
		...
		{Name: "by_owner_integration", KeyPath: []string{"owner_kind", "owner_id", "integration"}},
		{Name: "by_owner_connection", KeyPath: []string{"owner_kind", "owner_id", "integration", "connection"}},
	},
	Columns: []indexeddb.ColumnDef{
		{Name: "id", Type: indexeddb.TypeString, PrimaryKey: true},
