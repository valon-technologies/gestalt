output "github_actions_variables" {
  description = "GitHub Actions repository variables required by gestaltd release and CI artifact workflows."
  value = {
    ...
    GESTALTD_CI_GCP_WORKLOAD_IDENTITY_PROVIDER = local.ci_binary_workload_identity_provider
...
output "ci_binary_workload_identity_provider" {
  description = "Workload Identity provider resource name used by the gestaltd CI binary artifact workflow."
  value       = local.ci_binary_workload_identity_provider
}
