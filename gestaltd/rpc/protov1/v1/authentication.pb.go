...
const file_v1_authentication_proto_rawDesc = "" +
	...
	"\x13session_ttl_seconds\x18\x01 \x01(\x03R\x11sessionTtlSeconds2\xfa\x03\n" +
	...
	"host_state\x8a\xb5\x18\x06scopes\x12\x86\x01\n" +
	"\rCompleteLogin\x12).gestalt.provider.v1.CompleteLoginRequest\x1a&.gestalt.provider.v1.AuthenticatedUser\"\"\x8a\xb5\x18\x0eprovider_state\x8a\xb5\x18\fcallback_url\x12}\n" +
