...
var (
	...
	E_OptionalResult = &file_v1_annotations_proto_extTypes[2]
	// optional gestalt.provider.v1.Keyed keyed = 50002;
	E_Keyed = &file_v1_annotations_proto_extTypes[3]
	...
	E_Unwrap = &file_v1_annotations_proto_extTypes[4]
)
...
var (
	...
	E_HostBinding = &file_v1_annotations_proto_extTypes[5]
)
...
const file_v1_annotations_proto_rawDesc = "" +
	...
	"\aframing\x12\x1e.google.protobuf.MethodOptions\x18҆\x03 \x01(\v2\x1c.gestalt.provider.v1.FramingR\aframing:o\n" +
...
var file_v1_annotations_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
...
var file_v1_annotations_proto_depIdxs = []int32{
	3, // 0: gestalt.provider.v1.signature:extendee -> google.protobuf.MethodOptions
	3, // 1: gestalt.provider.v1.framing:extendee -> google.protobuf.MethodOptions
	4, // 2: gestalt.provider.v1.optional_result:extendee -> google.protobuf.MessageOptions
	4, // 3: gestalt.provider.v1.keyed:extendee -> google.protobuf.MessageOptions
	4, // 4: gestalt.provider.v1.unwrap:extendee -> google.protobuf.MessageOptions
	5, // 5: gestalt.provider.v1.host_binding:extendee -> google.protobuf.ServiceOptions
	2, // 6: gestalt.provider.v1.framing:type_name -> gestalt.provider.v1.Framing
	0, // 7: gestalt.provider.v1.optional_result:type_name -> gestalt.provider.v1.OptionalResult
	1, // 8: gestalt.provider.v1.keyed:type_name -> gestalt.provider.v1.Keyed
