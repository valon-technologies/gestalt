...
func (x *DeleteRelationshipRequest) GetSourceLayer() SourceLayer {
	if x != nil {
		return x.SourceLayer
	}
	return SourceLayer_SOURCE_LAYER_UNSPECIFIED
...
const file_v1_authorization_proto_rawDesc = "" +
	...
	"\frelationship\x18\x01 \x01(\v2!.gestalt.provider.v1.RelationshipR\frelationship\"\xb7\x01\n" +
	"\x19DeleteRelationshipRequest\x12U\n" +
	"\x12relationship_tuple\x18\x01 \x01(\v2&.gestalt.provider.v1.RelationshipTupleR\x11relationshipTuple\x12C\n" +
	"\fsource_layer\x18\x02 \x01(\x0e2 .gestalt.provider.v1.SourceLayerR\vsourceLayer\"\x1c\n" +
...
var file_v1_authorization_proto_depIdxs = []int32{
	...
	1,  // 17: gestalt.provider.v1.DeleteRelationshipRequest.source_layer:type_name -> gestalt.provider.v1.SourceLayer
	18, // 18: gestalt.provider.v1.SetRelationshipsRequest.relationships:type_name -> gestalt.provider.v1.Relationship
	18, // 19: gestalt.provider.v1.SetRelationshipsResponse.relationships:type_name -> gestalt.provider.v1.Relationship
	...
	36, // 30: gestalt.provider.v1.AuthorizationModelRef.created_at:type_name -> google.protobuf.Timestamp
	25, // 31: gestalt.provider.v1.AuthorizationModelResourceType.relations:type_name -> gestalt.provider.v1.AuthorizationModelRelation
	26, // 32: gestalt.provider.v1.AuthorizationModelResourceType.actions:type_name -> gestalt.provider.v1.AuthorizationModelAction
	1,  // 33: gestalt.provider.v1.AuthorizationModelResourceType.source_layer:type_name -> gestalt.provider.v1.SourceLayer
	27, // 34: gestalt.provider.v1.AuthorizationModelRelation.allowed_targets:type_name -> gestalt.provider.v1.AuthorizationModelAllowedTarget
	28, // 35: gestalt.provider.v1.AuthorizationModelAllowedTarget.subject_set_type:type_name -> gestalt.provider.v1.SubjectSetType
	23, // 36: gestalt.provider.v1.GetActiveModelRefResponse.model:type_name -> gestalt.provider.v1.AuthorizationModelRef
	22, // 37: gestalt.provider.v1.SetActiveModelRequest.model:type_name -> gestalt.provider.v1.AuthorizationModel
	23, // 38: gestalt.provider.v1.SetActiveModelResponse.model:type_name -> gestalt.provider.v1.AuthorizationModelRef
	...
	24, // 41: gestalt.provider.v1.ListActiveModelResourceTypesResponse.resource_types:type_name -> gestalt.provider.v1.AuthorizationModelResourceType
	9,  // 42: gestalt.provider.v1.AuthorizationProvider.ListRelationships:input_type -> gestalt.provider.v1.ListRelationshipsRequest
	12, // 43: gestalt.provider.v1.AuthorizationProvider.AddRelationship:input_type -> gestalt.provider.v1.AddRelationshipRequest
	14, // 44: gestalt.provider.v1.AuthorizationProvider.DeleteRelationship:input_type -> gestalt.provider.v1.DeleteRelationshipRequest
	16, // 45: gestalt.provider.v1.AuthorizationProvider.SetRelationships:input_type -> gestalt.provider.v1.SetRelationshipsRequest
	37, // 46: gestalt.provider.v1.AuthorizationProvider.GetActiveModelRef:input_type -> google.protobuf.Empty
	30, // 47: gestalt.provider.v1.AuthorizationProvider.SetActiveModel:input_type -> gestalt.provider.v1.SetActiveModelRequest
	32, // 48: gestalt.provider.v1.AuthorizationProvider.ListActiveModelResourceTypes:input_type -> gestalt.provider.v1.ListActiveModelResourceTypesRequest
	5,  // 49: gestalt.provider.v1.AuthorizationProvider.CheckAccess:input_type -> gestalt.provider.v1.CheckAccessRequest
	7,  // 50: gestalt.provider.v1.AuthorizationProvider.CheckAccessMany:input_type -> gestalt.provider.v1.CheckAccessManyRequest
	11, // 51: gestalt.provider.v1.AuthorizationProvider.ListRelationships:output_type -> gestalt.provider.v1.ListRelationshipsResponse
	13, // 52: gestalt.provider.v1.AuthorizationProvider.AddRelationship:output_type -> gestalt.provider.v1.AddRelationshipResponse
	15, // 53: gestalt.provider.v1.AuthorizationProvider.DeleteRelationship:output_type -> gestalt.provider.v1.DeleteRelationshipResponse
	17, // 54: gestalt.provider.v1.AuthorizationProvider.SetRelationships:output_type -> gestalt.provider.v1.SetRelationshipsResponse
	29, // 55: gestalt.provider.v1.AuthorizationProvider.GetActiveModelRef:output_type -> gestalt.provider.v1.GetActiveModelRefResponse
	31, // 56: gestalt.provider.v1.AuthorizationProvider.SetActiveModel:output_type -> gestalt.provider.v1.SetActiveModelResponse
	34, // 57: gestalt.provider.v1.AuthorizationProvider.ListActiveModelResourceTypes:output_type -> gestalt.provider.v1.ListActiveModelResourceTypesResponse
	6,  // 58: gestalt.provider.v1.AuthorizationProvider.CheckAccess:output_type -> gestalt.provider.v1.CheckAccessResponse
	8,  // 59: gestalt.provider.v1.AuthorizationProvider.CheckAccessMany:output_type -> gestalt.provider.v1.CheckAccessManyResponse
