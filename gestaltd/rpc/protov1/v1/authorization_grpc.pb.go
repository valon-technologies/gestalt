...
const (
	...
	AuthorizationProvider_SetRelationships_FullMethodName             = "/gestalt.provider.v1.AuthorizationProvider/SetRelationships"
...
type AuthorizationProviderClient interface {
	...
	SetRelationships(ctx context.Context, in *SetRelationshipsRequest, opts ...grpc.CallOption) (*SetRelationshipsResponse, error)
...
func (c *authorizationProviderClient) SetRelationships(ctx context.Context, in *SetRelationshipsRequest, opts ...grpc.CallOption) (*SetRelationshipsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SetRelationshipsResponse)
	err := c.cc.Invoke(ctx, AuthorizationProvider_SetRelationships_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAuthorizationProviderServer) SetRelationships(context.Context, *SetRelationshipsRequest) (*SetRelationshipsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SetRelationships not implemented")
}
...
func _AuthorizationProvider_SetRelationships_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SetRelationshipsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthorizationProviderServer).SetRelationships(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthorizationProvider_SetRelationships_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthorizationProviderServer).SetRelationships(ctx, req.(*SetRelationshipsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthorizationProvider_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SetRelationships",
			Handler:    _AuthorizationProvider_SetRelationships_Handler,
		},
		{
