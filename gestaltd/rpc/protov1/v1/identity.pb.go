...
type TokenRequest struct {
	...
	GrantSubject  string `protobuf:"bytes,12,opt,name=grant_subject,json=grantSubject,proto3" json:"grant_subject,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TokenRequest) GetGrantSubject() string {
	if x != nil {
...
const file_v1_identity_proto_rawDesc = "" +
	...
	"\rgrant_subject\x18\f \x01(\tR\fgrantSubjectJ\x04\b\x04\x10\x05R\rrefresh_token\"\xc6\x01\n" +
	"\rTokenResponse\x12!\n" +
	...
	"\vRevokeGrant\x12'.gestalt.provider.v1.RevokeGrantRequest\x1a(.gestalt.provider.v1.RevokeGrantResponse\"D\x8a\xb5\x18\bgrant_id\xfa\xd2\xe4\x93\x02\b\x12\x06PUBLIC\x82\xd3\xe4\x93\x02$*\"/api/v2/identity/grants/{grant_id}\x1a\f\x8a\xb5\x18\bidentityBCZAgithub.com/valon-technologies/gestalt/server/rpc/protov1/v1;protob\x06proto3"
