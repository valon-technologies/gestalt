...
type (
	ExternalCredential                      = sdkexternalcredentials.ExternalCredential
	ExternalCredentialLookup                = sdkexternalcredentials.ExternalCredentialLookup
	UpsertExternalCredentialRequest         = sdkexternalcredentials.UpsertExternalCredentialRequest
	GetExternalCredentialRequest            = sdkexternalcredentials.GetExternalCredentialRequest
	ListExternalCredentialsRequest          = sdkexternalcredentials.ListExternalCredentialsRequest
	ListExternalCredentialsResponse         = sdkexternalcredentials.ListExternalCredentialsResponse
	DeleteExternalCredentialRequest         = sdkexternalcredentials.DeleteExternalCredentialRequest
	ExternalCredentialTokenExchangeDriver   = sdkexternalcredentials.ExternalCredentialTokenExchangeDriver
	ExternalCredentialAuthConfig            = sdkexternalcredentials.ExternalCredentialAuthConfig
	ValidateExternalCredentialConfigRequest = sdkexternalcredentials.ValidateExternalCredentialConfigRequest
	ResolveExternalCredentialRequest        = sdkexternalcredentials.ResolveExternalCredentialRequest
	ResolveExternalCredentialResponse       = sdkexternalcredentials.ResolveExternalCredentialResponse
	ExternalCredentialTokenResponse         = sdkexternalcredentials.ExternalCredentialTokenResponse
	ExchangeExternalCredentialRequest       = sdkexternalcredentials.ExchangeExternalCredentialRequest
	ExchangeExternalCredentialResponse      = sdkexternalcredentials.ExchangeExternalCredentialResponse
)
