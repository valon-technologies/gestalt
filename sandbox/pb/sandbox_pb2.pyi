...
class ToolResponse(_message.Message):
    __slots__ = ("is_error", "result_json", "error_message")
    IS_ERROR_FIELD_NUMBER: _ClassVar[int]
    ...
    result_json: str
    error_message: str
    def __init__(self, is_error: bool = ..., result_json: _Optional[str] = ..., error_message: _Optional[str] = ...) -> None: ...
...
class ToolDefinition(_message.Message):
    __slots__ = ("name", "provider", "operation", "description", "input_schema_json", "annotations")
    ...
    def __init__(self, name: _Optional[str] = ..., provider: _Optional[str] = ..., operation: _Optional[str] = ..., description: _Optional[str] = ..., input_schema_json: _Optional[str] = ..., annotations: _Optional[_Union[ToolAnnotations, _Mapping]] = ...) -> None: ...

class ToolAnnotations(_message.Message):
    __slots__ = ("read_only", "destructive", "idempotent")
    ...
    destructive: bool
    idempotent: bool
    def __init__(self, read_only: bool = ..., destructive: bool = ..., idempotent: bool = ...) -> None: ...
